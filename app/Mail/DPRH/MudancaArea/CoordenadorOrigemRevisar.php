...
class CoordenadorOrigemRevisar extends Mailable
{
   ...
   public function build()
{
    return $this->from('automacao@plcadvogados.com.br', 'PORTAL PL&C ADVOGADOS')
                ->subject('*****[PLC][Notificação][Nova Solicitação de mudança de área]*****')
                ->view('Painel.Email.DPRH.MudancaArea.CoordenadorOrigemRevisar')
                ->with([
                    'datas' => $this->datas,
