  ...
  public function __construct(Coordenador $model)
  {
    ...
    public function index()
    {
      ...
      //  $totalPermissions   = Permission::count();
        ...
        $totalSolicitacoesCoordenadorAprovar = DB::table('PLCFULL.dbo.Jurid_Debite')
       ...
       $totalSolicitacoesCoordenadorAguardandoPagamento = DB::table('PLCFULL.dbo.Jurid_Debite')
                ->join('dbo.Jurid_Situacao_Ficha','PLCFULL.dbo.Jurid_Debite.Numero','=','dbo.Jurid_Situacao_Ficha.numerodebite')
                ->where('dbo.Jurid_Situacao_Ficha.status_id', '=', '12')
                ->where('PLCFULL.dbo.Jurid_Debite.Revisado_DB', '=', '1')
                ->count();
       
       $totalSolicitacoesCoordenadorPagas = DB::table('PLCFULL.dbo.Jurid_Debite')
                ->join('dbo.Jurid_Situacao_Ficha','PLCFULL.dbo.Jurid_Debite.Numero','=','dbo.Jurid_Situacao_Ficha.numerodebite')
      ...
      $notificacoes = DB::table('dbo.Hist_Notificacao')
       ...
       return view('Painel.Coordenador.Layouts.principal', compact('totalSolicitacoesCoordenadorAprovar','totalSolicitacoesCoordenadorAguardandoPagamento','totalSolicitacoesCoordenadorPagas', 'notificacoes',  'totalNotificacaoAbertas'));
    }
}