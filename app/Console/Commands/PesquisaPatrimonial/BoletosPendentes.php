...
use Carbon\Carbon;
use App\Mail\PesquisaPatrimonial\BoletosPendenteProgramacao;
use WGenial\NumeroPorExtenso\NumeroPorExtenso;


class BoletosPendentes extends Command {


    protected $signature = 'pesquisapatrimonial_boletospendentes:cron';
    ...
    ->whereIn('dbo.PesquisaPatrimonial_Matrix.status_id', array(5,21,22))
    ->whereNull('PLCFULL.dbo.Jurid_Boleto_Remessa_Lista.codigo')
   ...
   if($datas->count() != 0) {
    ...
    ->cc('roberta.povoa@plcadvogados.com.br', 'isabela.silveira@plcadvogados.com.br', 'hudson.souza@plcadvogados.com.br', 'douglas.figueiredo@plcadvogados.com.br', 'gumercindo.ribeiro@plcadvogados.com.br', 'ronaldo.amaral@plcadvogados.com.br')
    ->send(new BoletosPendenteProgramacao($datas));
