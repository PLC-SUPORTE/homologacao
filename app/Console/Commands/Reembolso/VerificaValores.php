...
namespace App\Console\Commands\Reembolso;
...
use App\Mail\Reembolso\EnviaValorAcima;

class VerificaValores extends Command {


    protected $signature = 'reembolso_verificavalores:cron';


    protected $description = 'Verificação diaria se existe algum valor acima de 1500,00 para uma mesma pasta e solicitante.';
