                ...
                return _inherits(s, Component), _createClass(s, [{
                    ...
                    value: function(t, i) {
                        ...
                        for (var a = 0; a < e.length; a++) {
                            var r = e[a],
                                l = h("<li></li>");
                            r.data ? l.append('<span>' + r.key + "</span>") : l.append("<span>" + r.key + "</span>"), h(this.container).append(l), this._highlight(i, l)
                        }
                    }
                }, {
                    key: "open",
...
"undefined" != typeof self && self.Prism && self.document && document.querySelector && (self.Prism.fileHighlight = function(e) {
    ...
    Array.prototype.slice.call(e.querySelectorAll("pre[data-src]")).forEach(function(e) {
        if (!e.hasAttribute("data-src-loaded")) {
            ...
            o.className = "language-" + t, e.textContent = "", o.textContent = "Loadingâ€¦", e.appendChild(o);
            var l = new XMLHttpRequest;
            l.open("GET", a, !0), l.onreadystatechange = function() {
                4 == l.readyState && (l.status < 400 && l.responseText ? (o.textContent = l.responseText, Prism.highlightElement(o), e.setAttribute("data-src-loaded", "")) : 400 <= l.status ? o.textContent = "âœ– Error " + l.status + " while fetching file: " + l.statusText : o.textContent = "âœ– Error: File does not exist or is empty")
            }, l.send(null)
        }
    })
