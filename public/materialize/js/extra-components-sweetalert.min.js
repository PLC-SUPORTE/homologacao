$(function() {
    ...
    $(".btn-message").click(function() {
        ...
        swal({
            ...
            text: "Não será possível recuperar os dados deste registro.",
            icon: "warning",
            buttons: {
                cancel: "Cancelar",
                delete: "Excluir"
        ...
        swal({
            ...
            e ? swal("O registro foi excluído com sucesso!", {
                icon: "success"
        ...
        swal("Write something interesting:", {
            ...
            return !1 !== e && ("" === e ? (swal("You need to write something!", "", "error"), !1) : void swal("You typed: " + e))
        })
        ...
        swal({
            ...
            if (!e) throw null;
            return fetch("https://itunes.apple.com/search?term=" + e + "&entity=movie")
        }).then(function(e) {
            return e.json()
        }).then(function(e) {
            var t = e.results[0];
            if (!t) return swal("No movie was found!");
            var n = t.trackName,
                i = t.artworkUrl100;
            swal({
                title: "Top result:",
            ...
            e ? swal("Oh noes!", "The AJAX request failed!", "error") : (swal.stopLoading(), swal.close())
        })
    })
});