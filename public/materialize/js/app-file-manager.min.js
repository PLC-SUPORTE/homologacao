$(function() {
    ...
    if (0 < i.length) new PerfectScrollbar(".app-file-sidebar-content", {
        theme: "dark"
    });
    if (0 < s.length) new PerfectScrollbar(".app-file-sidebar-info", {
        theme: "dark"
    });
    $(".menu-toggle, .close-icon, .app-file-overlay").on("click", function(e) {
        o.removeClass("show"), a.removeClass("show"), s.removeClass("show")
    }), $(".app-file-info").on("click", function() {
        s.addClass("show"), a.addClass("show")
    }), $(".app-file-sidebar-close").on("click", function() {
        o.removeClass("show"), a.removeClass("show")
    }), $(".sidebar-toggle").on("click", function(e) {
        e.stopPropagation(), o.addClass("show"), a.addClass("show")
    });
    ...
    $(l).on("click", function() {
        ...
        768 < $(window).width() && a.hasClass("show") && (o.removeClass("show"), a.removeClass("show"), s.removeClass("show"))
    })
});