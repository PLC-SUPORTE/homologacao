$(document).ready(function() {
        if($(".invoice-data-table").length) {
            $(".invoice-data-table").DataTable( {
                    ...
                    ], order:[2, "asc"], dom:'<"top display-flex  mb-2"<"action-filters"f><"actions action-btns display-flex align-items-center">><"clear">rt<"bottom"p>', language: {
                        search:"", searchPlaceholder:"Buscar registros..."
                    }
