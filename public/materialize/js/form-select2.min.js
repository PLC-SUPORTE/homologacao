$(document).ready(function() {
        function e(e) {
            e.element; return e.id?"<i class='material-icons'>"+$(e.element).data("icon")+"</i>"+e.text:e.text
        }
        ...
        $(".select2").select2( {
                ...
                dropdownAutoWidth: !0, width:"100%", minimumResultsForSearch:1/0, templateResult:e, templateSelection:e, escapeMarkup:function(e) {
                    return e
                }
            }

        ), $(".max-length").select2( {
                dropdownAutoWidth: !0, width:"100%", maximumSelectionLength:2, placeholder:"Select maximum 2 items"
            }

        ); var t=$(".js-example-programmatic").select2( {
                dropdownAutoWidth: !0, width:"100%"
            }

        ), s=$(".js-example-programmatic-multi").select2(); s.select2( {
                dropdownAutoWidth: !0, width:"100%", placeholder:"Programmatic Events"
            }

        ), $(".js-programmatic-set-val").on("click", function() {
                t.val("CA").trigger("change")
            }
        ...
        $(".select2-data-array").select2( {
                dropdownAutoWidth: !0, width:"100%", data:[ {
                ...
                dropdownAutoWidth: !0, width:"100%", ajax: {
        ...
        ), $.fn.select2.amd.require(["select2/compat/matcher"], function(e) {
                $(".select2-customize-result").select2( {
                        dropdownAutoWidth: !0, width:"100%", placeholder:"Search by 'r'", matcher:e(i)
                    }
                ...
                dropdownAutoWidth: !0, width:"100%", placeholder:"Classic Theme", theme:"classic"
            }

        ), $(".select2-size-lg").select2( {
                dropdownAutoWidth: !0, width:"100%", containerCssClass:"select-lg"
            }
