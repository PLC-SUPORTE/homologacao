...
<div class="content-din">
    ...
    @endif
    @if( isset($categoria) )
        {!! Form::model($categoria, ['route' => ['Painel.TipoServico.update', $categoria->id], 'class' => 'form form-search form-ds', 'method' => 'PUT']) !!}
    @else
        {!! Form::open(['route' => 'Painel.TipoServico.store', 'class' => 'form form-search form-ds']) !!}
    @endif
