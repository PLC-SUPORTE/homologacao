            ...
            <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
               <div class="nav-wrapper">
                  <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
                     <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span style="color: white;">Histórico Solicitações</span></h5>
                     <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active" style="color: black;">Histórico Solicitações
                        </li>
                     </ol>
                     </ol>
                  </div>
                        ...
                        <table class="table invoice-data-table white border-radius-4 pt-1">
                            ...
                            <tbody>
                               ...
                               <tr>
                                 ...
                                 @if ($d->observacao == null || $d->observacao == '')
                                 ...
                                 <td style="font-size: 10px"><span class="bullet green"></span>Enviado para aprovação</td>
                                 <td>
