...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Verificar Solicitação | Portal PL&C</title>
...
<div class="invoice-filter-action mr-3">
  <a href="{{route('Painel.Compras.ComiteCompras.historico_comite_compras')}}" class="waves-effect waves-light btn modal-trigger tooltipped border-round" 
      ...
      <tbody>
         ...
         <tr>
           ...
           <td></td>
            ...
            @endif
            <td style="font-size: 10px">{{$d->setor}} - {{$d->descricao_setor}}</td>
            <td style="font-size: 10px">{{ date('d/m/Y', strtotime($d->datasolicitacao)) }}</td>
            <td style="font-size: 10px">{{$d->nomesolicitante}}</td>
            <td style="font-size: 10px;"><span class="bullet yellow"></span>Aguardando envio para aprovação</td>
            <td>
               <a href="{{route('Painel.Compras.ComiteCompras.formulario', $d->id)}}" style="color: gray;" class="material-icons">format_align_justify</a>
               {{-- <a href="{{route('Painel.Compras.ComiteCompras.downloadanexosolicitacao', $d->arquivo)}}" style="color: gray;" class="material-icons">attach_file</a> --}}
         </td>
         <td></td>
         </tr>
         @endif
