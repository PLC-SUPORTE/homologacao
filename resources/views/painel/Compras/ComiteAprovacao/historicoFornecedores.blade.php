...
<html class="loading" lang="pt-br" data-textdirection="ltr">
   <head>
      ...
      <title>Histórico Fornecedores</title>
            ...
            <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
               <div class="nav-wrapper">
                  <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
                     <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span style="color: white;">Histórico Fornecedores</span></h5>
                     <ol class="breadcrumbs mb-0">
                        <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{route('Painel.Compras.ComiteAprovacao.historico_comite_aprovacao')}}">Histórico</a>
                        </li>
                        <li class="breadcrumb-item active" style="color: black;">Histórico Fornecedores
                        </li>
                     </ol>
                     </ol>
                  </div>
            ...
            <div class="card" style="height: 580px;">
                <div class="card-content">
                        ...
                        @foreach ($dados as $d)
                              ...
                              <input style="font-size: 12px;" name="status" id="status" type="text" value="{{$d->status}}" readonly>
                           </div>
                               ...
                               <tbody>
                                 ...
                                 @foreach ($fornecedores as $f)
                                       ...
                                       <tr>
                                          ...
                                          <td style="font-size: 10px;">{{number_format($f->valor)}}</td>
                                          <td style="font-size: 10px;">{{$f->parcelas}}</td>
                                          <td style="font-size: 10px;">{{$f->frete}}</td>
                                          <td style="font-size: 10px;">{{$f->total}}</td>
                                              @if ($f->aprovado == 'Sim')
                                              <td style="font-size: 10px; color: green;"><span class="bullet green"></span>Aprovado</td>
                                              @else 
                                              <td style="font-size: 10px; color: red;"><span class="bullet red"></span>Reprovado</td>
                                              @endif
                                          </td>
                                       </tr>
