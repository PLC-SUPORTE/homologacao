            ...
            <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
               <div class="nav-wrapper">
                  <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
                     <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span style="color: white;">Histórico</span></h5>
            ...
            <div class="container">
               <div class="section">
                  <section class="invoice-list-wrapper section">
                     ...
                     <a  href="{{route('Painel.Compras.Solicitante.novasolicitacao')}}" class="btn-floating btn-mini waves-effect waves-light buttons-right tooltipped" data-position="left" data-tooltip="Clique aqui para cadastrar uma nova proposta." style="background-color: gray;"><i class="material-icons">add</i></a>
                     </div> --}}
                        ...
                        <table class="table invoice-data-table white border-radius-4 pt-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   @if ($d->observacoes == '' || $d->observacoes == null)
                                   <td style="font-size: 10px"><span class="bullet red"></span>Não possui</td>
                                   @else 
                                   <td style="font-size: 10px">{{$d->observacoes}}</td>
                                   @endif
                                   @if ($d->status_solicitacao == '3')
                                       <td style="font-size: 10px"><span class="bullet green"></span>Solicitação aprovada</td>
                                   @elseif($d->status_solicitacao == '4') 
                                       <td style="font-size: 10px"><span class="bullet red"></span>Solicitação reprovada</td>
                                   @endif
                                   <td><a style="color: gray;" href="{{route('Painel.Compras.ComiteAprovacao.downloadanexoaprovacao', $d->arquivo)}}" 
                                    class="material-icons">attach_file</a>
                                    <a style="color: gray;" href="{{route('Painel.Compras.ComiteAprovacao.historico_fornecedores', $d->id_solicitante)}}" class="material-icons">remove_red_eye</a>
                                 </td>
                                   <td></td>
                                </tr>
                                @endif
