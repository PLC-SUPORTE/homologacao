            ...
            <div class="container">
               <div class="section">
                  <section class="invoice-list-wrapper section">
                     {{-- <div class="invoice-filter-action mr-3 right align">
                     <a  href="{{route('Painel.Compras.ComiteAprovacao.historico_comite_aprovacao')}}" 
                     class="btn-floating btn-mini waves-effect waves-light buttons-right tooltipped" 
                     data-position="left" data-tooltip="Clique aqui para acessar o histórico." 
                     style="background-color: gray;"><i class="material-icons">list</i></a>
                     </div> --}}
                     <div class="invoice-filter-action mr-3">
                        <a  href="{{route('Painel.Compras.ComiteAprovacao.historico_comite_aprovacao')}}"  class="waves-effect waves-light btn modal-trigger tooltipped border-round" 
                        data-position="left" data-tooltip="Clique aqui para acessar o histórico de solicitações." 
                        style="background-color: gray;color:white;font-size:11px;"><i class="material-icons left">list_alt</i> Histórico</a>
                        ...
                        <table class="table invoice-data-table white border-radius-4 pt-1">
                            <thead>
                               <tr>
                                  ...
                                  <th style="font-size: 11px">Id Solicitante</th>
                                  <th style="font-size: 11px">Nome Solicitante</th>
                                  <th style="font-size: 11px">Quantidade</th>
                                  <th style="font-size: 11px">Especificações</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($dados as $d)
                                @if ($d->status_solicitacao == '2' || $d->status_solicitacao == '5')
                                <tr>
                                   <td></td>
                                   <td style="font-size: 10px">{{$d->id_solicitante}}</td>
                                   <td style="font-size: 10px">{{$d->nomesolicitante}}</td>
                                   <td style="font-size: 10px">{{$d->id}}</td>
                                   <td style="font-size: 10px">{{$d->quantidade}}</td>
                                   <td style="font-size: 10px">{{$d->especificacoes}}</td>
                                   <td style="font-size: 10px">{{$d->observacoes}}</td>
                                   @if ($d->status_comite == 'Urgente')
                                       <td style="font-size: 10px"><span class="bullet red"></span>{{$d->status_comite}}</td>
                                   @else 
                                       <td style="font-size: 10px"><span class="bullet green"></span>{{$d->status_comite}}</td>
                                   @endif
                                   <td><a style="color: gray;" href="{{route('Painel.Compras.ComiteAprovacao.downloadAnexoAprovacao', $d->arquivo)}}" class="material-icons">attach_file</a>
                                   <a style="color: gray;" href="{{route('Painel.Compras.ComiteAprovacao.aprovar', $d->id_solicitante)}}" class="material-icons">remove_red_eye</a>
                                   </td>
                                   <td></td>
                                   @endif
                                </tr>
