...
<?php $search = 2 ?>
@section('title') Meu score acumulado @endsection <!-- Titulo da pagina -->
...
@section('header') 
   <meta http-equiv="Content-Language" content="pt-br">
    ...
    <title>Meu score acumulado | Portal PL&C</title>
...
<li class="breadcrumb-item active" style="color: black;">Score acumulado
</li>
@endsection
@section('body')
    <div>
  ...
  <div id="loading">
     ...
     <h1 style="text-align: center;">Aguarde, estamos carregando seu score acumulado...&hellip;</h1>
     </div>
  </center>   
          ...
          <div class="container">
            ...
            <a href="{{ route('Painel.Gestao.Meritocracia.index') }}" class="btn-floating btn-mini waves-effect waves-light buttons-right tooltipped" data-position="top" data-tooltip="Dashboard individual acumulado" style="margin-top: -15px;background-color: gray;"><i class="material-icons">home</i></a>
              ...
              <div class="input-field col s4 align right" style="margin-top: -12px;">
                ...
                <a href="{{ route('Painel.Gestao.Meritocracia.minhasnotasmes') }}" class="btn-floating btn-mini waves-effect waves-light tooltipped"data-position="left" data-tooltip="Clique aqui para visualizar o seu score consolidado."  style="margin-left: 5px;margin-top:-5px;background-color: gray;"><i class="material-icons">bar_chart</i></a>
            ...
            <div class="card-content">
               ...
               <div class="current-balance-container tooltipped" data-position="top" data-tooltip="O gráfico apresenta o desempenho acumulado durante o período, com a consolidação das notas de seus respectivos indicadores.">
               <center>
               <canvas id="notaacumulada" style="width: 200px; height: 100px;margin-left:-55px"></canvas>
               </center>
               </div>
               <p class="medium-small center-align" style="margin-left: -70px;">{{$notaconsolidada}}</p>
               <p class="medium-small center-align" style="margin-left: -70px;">Score acumulado</p>
