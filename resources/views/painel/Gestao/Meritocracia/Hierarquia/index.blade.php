...
<?php $search = 2 ?>
@section('title') Dashboard meritocracia @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Dashboard meritoracia
</li>
@endsection
@section('body')
    <div>
   <div class="row">
        ...
        <div class="card-content" style="padding: 14px;">
            ...
            O quadro abaixo mostra as notas dos sócios em sua hierarquia referente ao último mês de apuração.
            </p>
        </div>
    </div>
