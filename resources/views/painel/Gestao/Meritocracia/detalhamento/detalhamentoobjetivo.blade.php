...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Detalhamento indicador | Portal PL&C</title>
...
<div class="card">
        <div class="card-content" style="padding: 10px;">
            ...
            O quadro abaixo retrata o detalhamento do seu indicador mês a mês.
            </p>
        </div>
    </div>

    <a href="{{ route('Painel.Gestao.Meritocracia.detalhamento') }}" style="background-color: gray; margin-top: -60px;margin-left: 97%" class="btn-floating btn-mini waves-effect waves-light buttons-right tooltipped" data-position="bottom" data-tooltip="Clique aqui para voltar e detalhar suas notas."><i class="material-icons">undo</i></a>
  ...
  <table id="data-table-simple" class="display">
      <thead>
        ...
        <th style="font-size: 13px"></th>
          ...
          <th style="font-size: 13px">Score consolidado</th>
          <th style="font-size: 13px">Score acumulado</th>
        </tr>
      </thead>
