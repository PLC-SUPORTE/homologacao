...
<?php $search = 2 ?>
@section('title') Valor orçado mensal @endsection
<!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Valor orçado mensal
</li>
@endsection
@section('body')
    <div>
                        ...
                        <section class="invoice-list-wrapper section">
                            ...
                            <div class="invoice-filter-action mr-4">
                                <a href="#modal"
                                    ...
                                    data-position="left"
                                    data-tooltip="Clique aqui para adicionar um novo lançamento de valor orçado mensal."
                                    style="margin-left: 5px;background-color: gray;"><i
                                        class="material-icons">add</i></a>
                                <a href="{{ route('Painel.Gestao.Controlador.ValorOrcado.Mensal.exportar') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 11px">
                                                ...
                                                <div class="invoice-action">
                                                    <a href="{{route('Painel.Gestao.Controlador.ValorOrcado.Mensal.editar', $data->id)}}"
        ...
        <div id="modal" class="modal" style="width: 1200px;">
            <form id="form" role="form"
                action="{{ route('Painel.Gestao.Controlador.ValorOrcado.Mensal.gravarregistro') }}" method="POST"
                role="create">
                {{ csrf_field() }}
                ...
                <div class="modal-content">
                    ...
                    <div id="corpodiv">
                        ...
                        <h5>Novo valor orçado mensal</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s2">
                                <label>Ano:</label>
                                <input value="{{$anoatual}}" id="ano" name="ano" class="form-control" type="text"
                                    maxlength="4" pattern="(?:\.|,|[0-9])*" placeholder="Ano">
                            </div>
                            ...
                            <div class="input-field col s2">
                                <select class="browser-default" name="ativo" required>
