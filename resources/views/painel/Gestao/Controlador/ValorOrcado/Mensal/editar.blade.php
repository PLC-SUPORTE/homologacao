...
<?php $search = 2 ?>
@section('title') Editar valor orçado mensal @endsection
<!-- Titulo da pagina -->

@section('header')
<title>Editar valor orçado mensal | Portal PL&C</title>
...
Editar valor orçado mensal
@endsection
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Gestao.Controlador.index') }}">Dashboard</a>
</li>
<li class="breadcrumb-item"><a href="{{ route('Painel.Gestao.Controlador.ValorOrcado.Mensal.index') }}">Valor orçado
        mensal</a>
</li>
<li class="breadcrumb-item active" style="color: black;">Editar valor orçado mensal
</li>
@endsection
@section('body')
    <div>
                    ...
                    <div id="Form-advance" class="card card card-default scrollspy">
                        <div class="card-content">
                            <form id="form" role="form"
                                action="{{ route('Painel.Gestao.Controlador.ValorOrcado.Mensal.editado') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col m3 s2">
                                        ...
                                        <select class="select2 browser-default" name="mes" required>
                                            <option value="{{$datas->mes_id}}">{{$datas->mes}}</option>
                                            @foreach($meses as $mes)
                                            <option value="{{$mes->id}}">{{$mes->descricao}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-field col m2 s12">
                                        <span>Ano</span>
                                        <input value="{{$datas->ano}}" id="ano" name="ano" class="form-control"
                                            type="text">
                                    </div>
                                    ...
                                    <div class="input-field col m3 s2">
                                        ...
                                        <select class="select2 browser-default" name="ativo" required>
                                            @if($datas->ativo == "S")
                                            <option value="S" checked>Ativo</option>
                                            <option value="I">Ínativo</option>
                                            @else
                                            <option value="S">Ativo</option>
                                            <option value="I" checked>Ínativo</option>
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="right-align">
                                    <a class="btn red"
                                        href="{{route('Painel.Gestao.Controlador.ValorOrcado.Mensal.index')}}"><i
