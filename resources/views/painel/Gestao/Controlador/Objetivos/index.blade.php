...
<?php $search = 2 ?>
@section('title') Objetivos @endsection
<!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Objetivos
</li>
@endsection
@section('body')
    <div>
                        ...
                        <section class="invoice-list-wrapper section">
                            ...
                            <div class="invoice-filter-action mr-4">
                                <a href="#modal"
                                    ...
                                    data-position="left" data-tooltip="Clique aqui para adicionar um novo indicador."
                                    style="margin-left: 5px;background-color: gray;"><i
                                        class="material-icons">add</i></a>
                                <a href="{{ route('Painel.Gestao.Controlador.Objetivos.exportar') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 11px">
                                                ...
                                                <div class="invoice-action">
                                                    <a href="{{route('Painel.Gestao.Controlador.Objetivos.editar', $data->id)}}"
        ...
        <div id="modal" class="modal" style="width: 1200px;">
            <form id="form" role="form" action="{{ route('Painel.Gestao.Controlador.Objetivos.gravarregistro') }}"
                    ...
                    <div id="corpodiv">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                <input id="icon_telephone" type="text" name="objetivo" class="validate"
