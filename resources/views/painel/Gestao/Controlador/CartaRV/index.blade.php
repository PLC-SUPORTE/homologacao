...
<?php $search = 2 ?>
@section('title') Informativo de RV @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Informativo de RV
</li>
@endsection
@section('body')
      <div>
         <div class="row">
            <center>
               <div id="loading">
                  ...
                  <h1 style="text-align: center;">Aguarde, estamos carregando o histórico do mês de apuração...&hellip;</h1>
               </div>
            </center>
               ...
               <div class="col s12">
                  <div class="container">
                     ...
                     <div class="invoice-filter-action mr-4">
                       ...
                       <a  href="{{ route('Painel.Gestao.Controlador.CartaRV.exportarmes') }}" class="btn-floating btn-mini waves-effect waves-light buttons-right tooltipped" data-position="left" data-tooltip="Clique aqui para exportar em Excel os informativos de RV do mês de apuração." style="background-color: gray;"><img style="margin-top: 8px; width: 20px;margin-left:8px;" src="{{URL::asset('/public/imgs/icon.png')}}"/></a>
                       </div>
                           ...
                           <table class="table invoice-data-table white border-radius-4 pt-1" style="width: 100%;">
                              <thead>
                                 <tr>
                                    ...
                                    <th style="font-size: 12px">RV Máximo</th>
                                    <th style="font-size: 12px">RV Apurado</th>
                                    <th style="font-size: 12px">RV Recebido</th>
                                    <th style="font-size: 12px">RV Projetado</th>
                                    <th style="font-size: 12px"></th>
                                 </tr>
                              </thead>
                              <tbody>
