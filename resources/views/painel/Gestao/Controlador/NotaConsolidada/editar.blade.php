...
<?php $search = 2 ?>
@section('title') Editar nota consolidada @endsection
<!-- Titulo da pagina -->
...
Editar lançamento de nota consolidada
@endsection
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Gestao.Controlador.index') }}">Dashboard</a>
</li>
<li class="breadcrumb-item active" style="color: black;">Editar lançamento de nota consolidada
</li>
@endsection
@section('body')
    <div>
                    ...
                    <div id="Form-advance" class="card card card-default scrollspy">
                        <div class="card-content">
                            <form id="form" role="form"
                                action="{{ route('Painel.Gestao.Controlador.NotasConsolidada.editado') }}" method="POST"
                                role="create">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col m4 s12">
                                        <span>Nota consolidada mês</span>
                                        <input value="{{$datas->notaconsolidada}}" id="notaconsolidada"
                                            name="notaconsolidada" class="form-control" type="text" required>
                                    </div>


                                    <div class="input-field col m4 s12">
                                        <span>Nota acumulada</span>
                                        <input value="{{$datas->notaacumulada}}" id="notaacumulada" name="notaacumulada"
