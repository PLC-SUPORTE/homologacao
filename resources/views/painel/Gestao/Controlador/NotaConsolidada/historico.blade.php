...
<?php $search = 2 ?>
@section('title') Histórico Notas Consolidadas @endsection
<!-- Titulo da pagina -->
...
Histórico nota consolidada
@endsection
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Gestao.Controlador.index') }}">Dashboard</a>
</li>
<li class="breadcrumb-item"><a href="{{ route('Painel.Gestao.Controlador.NotasConsolidada.index') }}">Listagem mês</a>
</li>
<li class="breadcrumb-item active" style="color: black;">Histórico nota consolidada
</li>
@endsection
@section('body')
    <div>
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper">
                ...
                <center>
                    <div id="loading">
                        ...
                        <h1 style="text-align: center;">Aguarde, estamos carregando as notas consolidada do ano
                            atual...&hellip;</h1>
                    </div>
                </center>
                            ...
                            <section class="invoice-list-wrapper section">
                                ...
                                <div class="invoice-filter-action mr-4">
                                    <a href="{{ route('Painel.Gestao.Controlador.NotasConsolidada.exportarnotasmes') }}"
                                        ...
                                        data-position="left"
                                        data-tooltip="Clique aqui para exportar em Excel as notas consolidada do ano de apuração."
                                    ...
                                    <table class="table invoice-data-table white border-radius-4 pt-1"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="font-size: 12px">Nota consolidada</th>
                                                <th style="font-size: 12px"></th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-size: 11px">
                                                    {{mb_convert_case($data->usuario_nome, MB_CASE_TITLE, "UTF-8")}}
                                                </td>
