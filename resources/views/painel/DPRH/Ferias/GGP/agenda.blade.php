          ...
          <div class="nav-wrapper">
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -45px;">
              ...
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('Painel.DPRH.Ferias.Gerente.index') }}">Solicitações em andamento</a>
                </li>
...
<div id="app-calendar">
  <div class="row">
   ...
   <form id="form" role="form" action="{{ route('Painel.DPRH.Ferias.Gerente.solicitacaorevisada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <input type="hidden" name="solicitante_id" value="{{$data->SolicitanteID}}">
      ...
      <h6>[Workflow etapa 5 - Revisão da solicitação de férias]</h6>
