...
<section class="invoice-list-wrapper section">
  ...
  <a href="#modal" class="waves-effect waves-light btn modal-trigger tooltipped border-round" data-position="left" data-tooltip="Clique aqui para cadastro de uma nova solicitação." style="background-color: gray;color:white;font-size:11px;"><i class="material-icons left">add</i>Agenda</a>
  <a href="#modal" class="waves-effect waves-light btn modal-trigger tooltipped border-round" data-position="left" data-tooltip="Clique aqui para cadastro de uma nova solicitação." style="background-color: gray;color:white;font-size:11px;"><i class="material-icons left">add</i>Exportar</a>
  </div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      @foreach($datas as $data)  
        <tr>
          ...
          @if($data->StatusID == 4)
          <a href="{{route('Painel.DPRH.Ferias.Gerente.revisarsolicitacao', $data->id)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para revisar está solicitação de férias."><i class="material-icons">calendar_today</i></a>
          @endif
