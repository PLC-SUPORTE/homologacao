    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      @foreach($datas as $data)  
        <tr>
          ...
          @if($data->StatusID == 3)
          <a href="{{route('Painel.DPRH.Ferias.Superintendente.revisarsolicitacao', $data->id)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para revisar está solicitação de férias."><i class="material-icons">calendar_today</i></a>
          @endif
...
<div id="modal" class="modal" style="width: 1207px;">
    <form id="form" role="form" onsubmit="btnsubmit.disabled = true; return true;"  action="{{ route('Painel.DPRH.Ferias.Superintendente.solicitacaocriada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
