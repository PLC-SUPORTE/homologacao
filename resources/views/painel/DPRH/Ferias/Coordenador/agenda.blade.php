          ...
          <div class="nav-wrapper">
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -45px;">
              ...
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('Painel.DPRH.Ferias.Coordenador.index') }}">Solicitações em andamento</a>
                </li>
...
<div id="app-calendar">
  <div class="row">
   ...
   <form id="form" role="form" action="{{ route('Painel.DPRH.Ferias.Coordenador.solicitacaorevisada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <input type="hidden" name="solicitante_id" value="{{$data->SolicitanteID}}">
      ...
      <h6>[Workflow etapa 3 - Planejar solicitação de férias]</h6>
      <p style="font-size: 11px;">Favor realizar o planejamento desta solicitação de férias.</p>
    ...
    <div class="modal-footer" style="margin-top: 40px;margin-left: 20px;">
      ...
      <button type="button" id="btnsubmit" name="acao" onClick="abremodalconfirmando();" value="1" class="modal-action waves-effect waves-green btn-flat" style="background-color: gray;color:white;"><i class="material-icons left">check</i>Salvar planejamento</button>
