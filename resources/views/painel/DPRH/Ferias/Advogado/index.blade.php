...
<section class="invoice-list-wrapper section">
  ...
  <!-- <a href="" class="waves-effect waves-light btn modal-trigger tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar a agenda do seu setor de custo." style="background-color: gray;color:white;font-size:11px;"><i class="material-icons left">calendar_today</i> Agenda</a> -->
  <a href="{{ route('Painel.DPRH.Ferias.Advogado.historico') }}" class="waves-effect waves-light btn modal-trigger tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar a agenda do seu setor de custo." style="background-color: gray;color:white;font-size:11px;"><i class="material-icons left">list</i> Hístórico</a>
  </div>
...
<div id="modal" class="modal" style="width: 1207px;">
    <form id="form" role="form" onsubmit="btnsubmit.disabled = true; return true;"  action="{{ route('Painel.DPRH.Ferias.Advogado.solicitacaocriada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
  ...
  <div class="row">
        ...
        <input style="font-size: 10px;"  name="datafim" id="datafim" type="date"  min="{{$datahoje}}" class="form-control" data-toggle="tooltip" data-placement="top" title="Informe a data prevista para volta." required="required">
        </div>
