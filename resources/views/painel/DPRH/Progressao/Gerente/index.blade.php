...
<!--Inicio Modal Revisar --> 
    ...
    <form id="form2" role="form" onsubmit="btnsubmit2.disabled = true; return true;" onsubmit="btnsubmit3.disabled = true; return true;"  action="{{ route('Painel.DPRH.Progressao.Gerente.solicitacaorevisada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
  ...
  <h6>[Workflow etapa 5 - Revisão de solicitação de progressão]</h6>
