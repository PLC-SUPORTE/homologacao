...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>DPRH - Desligamento histórico | Portal PL&C</title>
        ...
        <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
          ...
          <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('Painel.DPRH.Desligamento.Superintendente.index') }}">Solicitações em andamento</a>
                </li>
...
<section class="invoice-list-wrapper section">
  ...
  <a href="{{ route('Painel.DPRH.Desligamento.Superintendente.index') }}" class="waves-effect waves-light btn tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações já finalizadas ou canceladas." style="background-color: gray;font-size:11px;"><i class="material-icons">keyboard_backspace</i>Voltar</a>
  </div>
  ...
  <div class="responsive-table">
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      <tr>
          ...
          <td style="font-size: 10px">{{ date('d/m/Y H:i:s', strtotime($data->DataSaida)) }}</td>
