        ...
        <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
          ...
          <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('Painel.DPRH.Desligamento.Coordenador.index') }}">Solicitações em andamento</a>
                </li>
...
<section class="invoice-list-wrapper section">
  ...
  <a href="{{ route('Painel.DPRH.Desligamento.Coordenador.index') }}" class="waves-effect waves-light btn tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações já finalizadas ou canceladas." style="background-color: gray;font-size:11px;"><i class="material-icons">keyboard_backspace</i>Voltar</a>
  </div>
