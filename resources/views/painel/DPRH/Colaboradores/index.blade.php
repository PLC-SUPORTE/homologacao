...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                [Formulário] -
                <small>[Listagem de colaboradores ativos na PL&C]</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ route('Painel.DPRH.principal') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Listagem de colaboradores ativos na PL&C </li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12">
                  <div class="float-right">
                      <small>
                          <a href="{{ route('Painel.DPRH.Colaboradores.gerarExcelAtivos')}}" class="delete" target="_blank"><span class="btn btn-success fa fa-file-excel-o"> Exportar Dados</span></a>
                      </small>
                  </div>
                    <div class="box ">
                    <div class="box-body">
