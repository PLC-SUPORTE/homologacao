    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th style="font-size: 11px">Data prevista ínicio</th>
          <th style="font-size: 11px">Data prevista retorno</th>
      ...
      @foreach($datas as $data)  
        <tr>
          ...
          <td style="font-size: 10px">{{ date('d/m/Y', strtotime($data->DataInicio)) }}</td>
          <td style="font-size: 10px">{{ date('d/m/Y', strtotime($data->DataFim)) }}</td>
...
<div id="modal" class="modal" style="width: 1207px;">
    <form id="form" role="form" onsubmit="btnsubmit.disabled = true; return true;"  action="{{ route('Painel.DPRH.Licenca.Advogado.store') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
  ...
  <button type="button" class="btn waves-effect mr-sm-1 mr-2 modal-close red" style="margin-top: -26px; margin-left: 1080px;position: fixed;"><i class="material-icons">close</i></button>
      ...
      <h6>[Workflow etapa 1 - Cadastro de solicitação de licenças]</h6>
      <p style="font-size: 11px;">Favor informar os dados para cadastro de um nova licença.</p>
      ...
      <br>
        ...
        <div class="input-field col m2 s12">
            ...
            <select style="font-size: 10px;" class="select2 browser-default" id="tipo" name="tipo"  data-toggle="tooltip" data-placement="top" title="Selecione o tipo de licença." required="required">
        ...
        <div class="input-field col m2 s12">
        <span style="font-size: 11px;">Data prevista para ínicio:</span>
        <input style="font-size: 10px;"  min="{{$datahoje}}" name="datainicio" id="datainicio" type="date"  class="form-control" data-toggle="tooltip" data-placement="top" title="Informe a data prevista para saída." required="required">
        </div>

        <div class="input-field col m2 s12">
        <span style="font-size: 11px;">Data prevista para fim:</span>
        <input style="font-size: 10px;"  min="{{$datahoje}}" name="datafim" id="datafim" type="date"  class="form-control" data-toggle="tooltip" data-placement="top" title="Informe a data prevista para saída." required="required">
        </div>
...
<div id="loadingdiv3" style="display:none">
  <div style="height: 50px;margin-top: calc(50vh - 150px);margin-left: calc(50vw - 600px);width: 180px;">
    ...
    <div id="corpodiv3">
    <div class="modal-content">
      <center><p style="font-size: 18px;">Deseja confirmar a solicitação de licença?</p></center>
    </div>
