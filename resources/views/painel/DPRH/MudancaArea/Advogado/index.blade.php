...
<div id="modal" class="modal" style="width: 1207px;">
    <form id="form" role="form" onsubmit="btnsubmit.disabled = true; return true;"  action="{{ route('Painel.DPRH.MudancaArea.Advogado.store') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}

    <input name="setororigem_codigo" type="hidden" value="{{$setoratual}}">
  ...
  <button type="button" class="btn waves-effect mr-sm-1 mr-2 modal-close red" style="margin-top: -26px; margin-left: 1080px;position: fixed;"><i class="material-icons">close</i></button>
      ...
      <h6>[Workflow etapa 1 - Cadastro de solicitação de mudança de área]</h6>
      <p style="font-size: 11px;">Favor informar os dados para cadastro de uma nova solicitação para mudança de área.</p>
      ...
      <br>
        ...
        <div class="input-field col m3 s12">
            ...
            <select style="font-size: 10px;" class="select2 browser-default" id="setor" name="setor"  data-toggle="tooltip" data-placement="top" title="Selecione o setor de custo para destino." required="required">
...
<div id="loadingdiv3" style="display:none">
  <div style="height: 50px;margin-top: calc(50vh - 150px);margin-left: calc(50vw - 600px);width: 180px;">
    ...
    <div id="corpodiv3">
    <div class="modal-content">
      <center><p style="font-size: 18px;">Deseja confirmar a solicitação de mudança de área?</p></center>
    </div>
