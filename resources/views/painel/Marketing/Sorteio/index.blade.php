...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Marketing - Sorteios | Portal PL&C</title>
      ...
      <div class="navbar navbar-fixed"> 
        <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
          ...
          <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span style="color: white;">Marketing</span></h5>
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{ route('Home.Principal.Show') }}">Home</a>
                </li>
                <li class="breadcrumb-item active" style="color: black;">Sorteios em andamento
                </li>
              </ol>
          </div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th style="font-size: 11px">Sorteio</th>
          <th style="font-size: 11px">Prêmio</th>
          <th style="font-size: 11px">Qtd. participantes</th>
          <th style="font-size: 11px">Nº vencedor</th>
          <th style="font-size: 11px">Vencedor</th>
          <th style="font-size: 11px">Data do resultado</th>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td style="font-size: 10px">{{$data->Sorteio}}</td>
            <td style="font-size: 10px">{{$data->Premio}}</td>
            <td style="font-size: 10px">{{$data->QuantidadeParticipantes}}</td>
            <td style="font-size: 10px">{{$data->VencedorNome}}</td>
            <td style="font-size: 10px">{{$data->Resultado}}</td>
            @if($data->Resultado != null)
            <td style="font-size: 10px">{{ date('d/m/Y H:i:s', strtotime($data->DataResultado)) }}</td>
            @else 
            <td style="font-size: 10px">Aguardando resultado</td>
            @endif
            @if($data->status == "Ativo")
            <td style="font-size: 10px;"><span class="bullet yellow"></span>Em andamento</td>
            @else 
            <td style="font-size: 10px;"><span class="bullet yellow"></span>Finalizado</td>
            @endif
            <td>

            <div class="invoice-action">
            @if($data->status == "Ativo")
            <a href="{{ route('Painel.Marketing.Sorteio.realizarsorteio', $data->id) }}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para sortear"><i class="material-icons">reduce_capacity</i></a>  
            @endif
            </div>
