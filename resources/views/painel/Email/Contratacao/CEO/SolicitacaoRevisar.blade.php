               ...
               <div class="content">
                  <table>
                     <tr>
                        <td>
                           <p>Prezado(a),</p>
                           <p>Uma solicitação de compra foi inserida.</p>
                           ...
                           <br>
                           <a href="{{route('Painel.Contratacao.CEO.index')}}" target="_blank" >CLIQUE AQUI para acessar está solicitação em nosso Portal.</a>
