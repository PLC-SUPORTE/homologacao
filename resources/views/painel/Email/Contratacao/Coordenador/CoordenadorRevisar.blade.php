                  ...
                  <table>
                     <tr>
                        <td>
                           ...
                           <br>
                           <a href="{{route('Painel.Contratacao.Coordenador.index')}}" target="_blank" >CLIQUE AQUI para acessar está solicitação em nosso Portal.</a>
                           <p>Você também pode acessar o portal e visualizar o histórico e o fluxo de acompanhamento da solicitação.</p>
