        ...
        <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
          ...
          <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <li class="breadcrumb-item"><a href="{{ route('Home.Principal.Show') }}">Home</a>
                ...
                <li class="breadcrumb-item"><a href="{{ route('Painel.Contratacao.Gerente.index') }}">Solicitações em andamento</a>
                </li>
...
<div class="invoice-filter-action mr-3">
  ...
  <a  href="{{ route('Painel.Contratacao.Gerente.historico') }}" class="waves-effect waves-light btn tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações já finalizadas ou canceladas." style="background-color: gray;font-size:11px;"><i"><i class="material-icons">list</i>Histórico</a>
  </div>
...
<!--Fim Modal Anexos --> 
    ...
    <form id="form" role="form" onsubmit="btnsubmit2.disabled = true; return true;" onsubmit="btnsubmit3.disabled = true; return true;"  action="{{ route('Painel.Contratacao.Gerente.solicitacaorevisada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
    ...
    <div class="modal-content">
     ...
     <h6>[Workflow etapa 4 - Revisão de solicitação de nova contratação]</h6>
...
<!--Fim Modal Revisar solicitação --> 
  ...
  <div id="modal" class="modal" style="width: 1207px;">
    <form id="form2" role="form" onsubmit="btnsubmit.disabled = true; return true;"  action="{{ route('Painel.Contratacao.Gerente.store') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
