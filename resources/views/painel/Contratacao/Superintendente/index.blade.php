...
<div class="invoice-filter-action mr-3">
  ...
  <a  href="{{ route('Painel.Contratacao.Superintendente.historico') }}" class="waves-effect waves-light btn tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações já finalizadas ou canceladas." style="background-color: gray;font-size:11px;"><i"><i class="material-icons">list</i>Histórico</a>
  </div>
...
<!--Fim Modal Anexos --> 
  ...
  <div id="loadingdiv" style="display:none; margin-left: 600px; margin-top: -300px;">
    ...
    <form id="form" role="form" onsubmit="btnsubmit2.disabled = true; return true;" onsubmit="btnsubmit3.disabled = true; return true;"  action="{{ route('Painel.Contratacao.Superintendente.solicitacaorevisada') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
  ...
  <h6>[Workflow etapa 3 - Revisão de solicitação de nova contratação]</h6>
...
<div id="modal" class="modal" style="width: 1207px;">
    <form id="form" role="form" onsubmit="btnsubmit.disabled = true; return true;"  action="{{ route('Painel.Contratacao.Superintendente.store') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
