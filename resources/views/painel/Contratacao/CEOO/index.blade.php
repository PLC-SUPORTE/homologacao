...
<div class="invoice-filter-action mr-3">
  <a  href="{{ route('Painel.Contratacao.CEOO.historico') }}" class="waves-effect waves-light btn tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações já finalizadas ou canceladas." style="background-color: gray;font-size:11px;"><i"><i class="material-icons">list</i>Histórico</a>
  </div>
...
<!--Fim Modal Anexos --> 
    ...
    <div id="modalrevisar{{$data->id}}" class="modal" style="width: 1207px;height:100%;overflow:hidden;">

    <!-- <button type="button" class="btn waves-effect mr-sm-1 mr-2 modal-close red" style="margin-left: 1120px; margin-top: 5px;">
    <i class="material-icons">close</i> 
    </button> -->

    <iframe style="height:100%;width:100%" 
    src="{{ route('Painel.Contratacao.CEOO.revisarsolicitacao', $data->id) }}"></iframe>
...
<!--Fim Modal Revisar solicitação --> 
          ...
          <div class="invoice-action">
           ...
           <a href="{{ route('Painel.Contratacao.CEOO.revisarsolicitacao', $data->id) }}" class="invoice-action-view mr-4 tooltipped modal-trigger" data-position="bottom" data-tooltip="Clique aqui para revisar está solicitação."><i class="material-icons">remove_red_eye</i></a>
           @endif
