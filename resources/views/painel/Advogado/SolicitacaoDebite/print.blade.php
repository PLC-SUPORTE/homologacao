    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <img src="{{url('/imgs/logo.png')}}" alt="Logo PLC" height="156" width="276">
            ...
            <tr>
             ...
             <td>R$ {{$numeroprocesso->ValorTotal}}</td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{route('Painel.Correspondente.anexo',$numeroprocesso->anexo)}}" class="delete"><span class="btn btn-success float-right fa fa-print">&nbsp;&nbsp;Download Anexo</span></a>
                  @if(!empty($datacomprovante->Link))
                  <a href="{{route('Painel.Correspondente.comprovante', $datacomprovante->anexo)}}" class="delete"><span class="btn btn-success float-right fa fa-print">&nbsp;&nbsp;Download Comprovante</span></a>
                  @endif
                </div>
              </div>
            </div>
