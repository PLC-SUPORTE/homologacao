...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Escritório - Solicitações finalizadas | Portal PL&C</title>
        ...
        <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
          ...
          <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('Painel.Escritorio.Solicitacoes.Advogado.index') }}">Solicitações em andamento</a>
                </li>
                <li class="breadcrumb-item active" style="color: black;">Solicitações finalizadas
                </li>
              </ol>
          </div>
...
<section class="invoice-list-wrapper section">
  ...
  <div id="cancelar{{$data->Id}}" class="modal"  style="width: 30% !important;height: 30% !important;">
