...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Escritório anexos | Portal PL&C</title>
...
<body data-open="click" data-menu="vertical-modern-menu" data-col="2-columns" style="overflow: hidden;">
 ...
 <!-- BEGIN: Page Main-->
    ...
    <div class="app-file-sidebar display-flex">
      <div class="app-file-sidebar-left">
        ...
        <!-- <div class="input-field add-new-file mt-0">
          ...
          <button class="add-file-btn btn btn-block waves-effect waves-light mb-10" style="background-color: gray;color:white;">
  ...
  <div id="anexos{{$data->Arq_nick}}" class="modal modal-fixed-footer" style="width: 100%;height:100%;overflow:hidden;">
      ...
      <iframe src="{{ url('storage/escritorio/solicitacoes/'.$data->Arq_nick) }}" width="100%" height="100%" style="border: none;"></iframe>
