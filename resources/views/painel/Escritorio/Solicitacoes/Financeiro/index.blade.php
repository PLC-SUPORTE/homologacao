...
<div class="invoice-filter-action mr-3">
  <a  href="{{ route('Painel.Escritorio.Solicitacoes.Financeiro.historico') }}" class="waves-effect waves-light btn tooltipped border-round" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações já finalizadas ou canceladas." style="background-color: gray;font-size:11px;"><i"><i class="material-icons">list</i>Histórico</a>
  </div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      <tbody>
         ...
         <tr>
            ...
            @if($data->StatusID == 2)
            <a href="{{route('Painel.Escritorio.Solicitacoes.Financeiro.formulario', $data->Id)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para revisar o formulário."><i class="material-icons">list</i></a>
            @endif
