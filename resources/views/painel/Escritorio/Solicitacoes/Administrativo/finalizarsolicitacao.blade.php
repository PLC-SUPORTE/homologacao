...
<html class="loading" lang="pt-br" data-textdirection="ltr">
   <head>
      ...
      <title>Escritório - Finalizar solicitação | Portal PL&C</title>
               ...
               <div class="nav-wrapper">
                  <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
                     ...
                     <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active" style="color: black;">Finalizar solicitação
                        </li>
                     </ol>
                     </ol>
                  </div>
            ...
            <div class="card" style="height: 100%;" id="card">
                <div class="card-content">
                   <div class="container" style="border: 1px solid #BBBBBB; border-radius: 10px;">
                     ...
                     <form id="form" role="form" action="{{ route('Painel.Escritorio.Solicitacoes.Administrativo.solicitacaofinalizada') }}" method="POST" role="create"  enctype="multipart/form-data">
                         {{ csrf_field() }}

                         <input type="hidden" name="id" value="{{$id}}">
                         <input type="hidden" name="solicitante_cpf" id="solicitante_cpf" value="{{$solicitante->UsuarioCPF}}">
                         ...
                         <div class="row">
                          ...
                          <div class="col s2">
                           ...
                           <div class="col s1">
                               ...
                               <input type="hidden" name="unidade" id="unidade" value="{{$solicitante->UnidadeCodigo}}">
                           </div>
                           ...
                           <textarea style="font-size: 10px; height: 45px;"  id="observacoes" name="observacoes" readonly >{{$solicitante->Observacao}}</textarea>
                           </div>
                   ...
                   <div class="container" style="border: 1px solid #BBBBBB; border-radius: 10px;">
                     ...
                     <h5 class="card-title" style="font-size: 11px;">Produto: {{$data->ProdutoDescricao}} - Quantidade: {{$data->ProdutoQuantidade}} - Área: {{$data->AreaDescricao}} - Setor: {{$data->SetorDescricao}}</h5>
                        ...
                        <div class="col s1">
                              ...
                              <input style="font-size: 10px;" id="valor" readonly value="<?php echo number_format($data->ValorUnitario,2,",",".") ?>" name="fornecedor_valornutario[]" pattern="(?:\.|,|[0-9])*" onKeyPress="return(moeda2(this,'.',',',event))" type="text" class="validate">
                        </div>
                        ...
                        <div class="col s1" id="div_frete_cartao">
                              ...
                              <input style="font-size: 10px;" id="frete" readonly value="<?php echo number_format($data->ValorFrete,2,",",".") ?>" name="fornecedor_valorfrete[]" type="text" class="validate" pattern="(?:\.|,|[0-9])*" onKeyPress="return(moeda2(this,'.',',',event))">
                        </div>

                        <div class="col s1" id="div_total">
                              <span style="font-size: 11px;">Total:</span>
                              <input style="font-size: 10px;" id="total" readonly value="<?php echo number_format($data->ValorTotal,2,",",".") ?>" name="fornecedor_valortotal[]"  type="text" pattern="(?:\.|,|[0-9])*" onKeyPress="return(moeda2(this,'.',',',event))" class="validate">
                        </div>
                        ...
                        <div class="input-field col s12">
                           <span style="font-size: 11px;">Inserir comprovante de pagamento :</span><br>
          
                           <input style="font-size: 10px;" required  type="file" id="anexo_boleto" name="anexo_boleto[]" accept=".jpg,.png,.xls,.xlsx,.pdf,.doc,.docx,.rtf,.jpeg" class="dropify" data-default-file=""/>
                        </div>
                        @elseif($data->formapagamento == "Cartão")


                        @else 
                        <div class="input-field col s12">
                           <span style="font-size: 11px;">Inserir comprovante de transferência :</span><br>
          
                           <input style="font-size: 10px;"  required type="file" id="anexo_transferencia" name="anexo_transferencia[]" accept=".jpg,.png,.xls,.xlsx,.pdf,.doc,.docx,.rtf,.jpeg" class="dropify" data-default-file=""/>
                        </div>
                        @endif
                     ...
                     <button id="btnsubmit" class="btn waves-light right align" style="margin-top: -60px; margin-right: 25px;background-color: green;font-size: 11px;" name="acao" value="aprovar" type="button" onClick="abremodalconfirmando();">Finalizar solicitação
...
<div id="loadingdiv3" style="display:none">
  <div style="height: 50px;margin-top: calc(50vh - 150px);margin-left: calc(50vw - 600px);width: 180px;">
    ...
    <div class="modal-content">
      <center><p style="font-size: 18px;">Deseja finalizar está solicitação de compra?</p>
      <p style="font-size: 11px;">Ao finalizar a solicitação de compra será gerado os debites automaticamente no sistema Advwin.</p>
