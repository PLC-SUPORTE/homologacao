...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Solicitação de pagamento anexos | Portal PL&C</title>
...
<body data-open="click" data-menu="vertical-modern-menu" data-col="2-columns" style="overflow: hidden;">
 ...
 <!-- BEGIN: Page Main-->
  ...
  <div id="anexos{{$data->Nome}}" class="modal modal-fixed-footer" style="width: 100%;height:100%;overflow:hidden;">
      ...
      <iframe src="https://docs.google.com/gview?url=https://portal.plcadvogados.com.br/portal/public/imgs/reembolso/{{$data->Nome}}&embedded=true" style="width:100%;height:1200px;" scrolling="no" frameborder="0" allowfullscreen></iframe> 
