...
@section('title') Workflow solicitação pagamento @endsection
<!-- Titulo da pagina -->
...
Workflow solicitação pagamento
@endsection
@section('submenu')
<li class="breadcrumb-item active" style="color: black">Workflow
</li>
@endsection
@section('body')
    <div class="Timeline" style="margin-top: -110px;">
        <svg id="firstLine" height="5" width="200">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        ...
        <svg style="margin-top: -99px;margin-left: 42px;" height="5">
        ...
        <svg id="svg-vertical" height="5" width="150">
            <line x1="0" y1="0" x2="120" y2="0" style="stroke:#F8C602;stroke-width:5" />
        </svg>
        <svg id="svg-vertical100" height="5">
            <line x1="0" y1="0" x2="450" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        <svg id="svg-vertical" height="5" width="150">
            <line x1="0" y1="0" x2="120" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg id="svg-vertical100" height="5">
            <line x1="0" y1="0" x2="450" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        <div class="event2" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação já foi aprovada pela equipe da revisão técnica.">
            <div class="event2Bubble">
                <div class="eventTime">
                </div>
                <div id="eventTitle3">Revisão Técnica</div>
        ...
        <svg id="svg-vertical100" height="5">
            <line x1="0" y1="0" x2="450" y2="0" style="stroke:green;stroke-width:5" />
        </svg>

        @elseif($statusAtual == "11")
        <div class="event2" data-placement="left"
            title="Sua solicitação já foi aprovada pela equipe da revisão técnica.">
            <div class="event2Bubble">
                <div class="eventTime">
                </div>
        ...
        <svg id="svg-vertical" height="5" width="150">
            <line x1="0" y1="0" x2="120" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg id="svg-vertical100" height="5">
            <line x1="0" y1="0" x2="450" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
    ...
    #svg-horizontal20{
        ...
        @if($statusAtual == "8")
        <svg id="svg-horizontal">
            <line x1="0" y1="0" x2="415" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg id="svg-vertical2">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg id="svg-horizontal2">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg id="svg-vertical3">
            <line x1="0" y1="0" x2="120" y2="0" style="stroke:#F8C602;stroke-width:5" />
        </svg>
        @elseif($statusAtual == "10")
        <svg id="svg-horizontal">
            <line x1="0" y1="0" x2="415" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg id="svg-vertical2">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg id="svg-horizontal2">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        @if($statusAtual == "7")
        <svg id="svg-horizontal4">
            <line x1="0" y1="0" x2="154" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg id="svg-horizontal5">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        ...
        @else
        <svg id="svg-horizontal4">
            <line x1="0" y1="0" x2="154" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg id="svg-horizontal5">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        ...
        @if($statusAtual == "7" )
        <div class="event5" id="event5" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação está neste processo.">
        ...
        @elseif($statusAtual == "9")
        <div class="event5" id="event5" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação já foi aprovada pela equipe do financeiro.">
            <div class="event5Bubble">
                <div id="eventTitle5">Revisão financeiro</div>
                <div style="margin-top: -28px;margin-left: -10px;">
                    <i class="fa fa-chevron-right" style="color: #bbbbbb60;"></i>
        ...
        @elseif($statusAtual == "10")
        <div class="event5" id="event5" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação foi reprovada pela equipe do financeiro.">
            <div class="event5Bubble">
                <div id="eventTitle5">Revisão financeiro</div>
                <div style="margin-top: -28px;margin-left: -10px;">
                    <i class="fa fa-chevron-right" style="color: #bbbbbb60;"></i>
        ...
        @else
        <div class="event5" id="event5" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação até o momento não foi aprovada pela equipe do financeiro.">
            <div class="event5Bubble">
                <div id="eventTitle5">Revisão financeiro</div>
                <div style="margin-top: -28px;margin-left: -10px;">
                    <i class="fa fa-chevron-right" style="color: #bbbbbb60;"></i>
        ...
        @if($statusAtual == "7")
        <svg id="svg-vertical5">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:red;stroke-width:5" />
        </svg>
        <svg id="svg-vertical5Complemento">
            <line x1="0" y1="0" x2="118" y2="0" style="stroke:#F8C602;stroke-width:5" />
        </svg>
        {{-- <svg id="svg-verticalRev"><line x1="0" y1="0" x2="60" y2="0" style="stroke:blue;stroke-width:5" /></svg> --}}
        <svg id="svg-horizontal7">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        <svg id="svg-vertical6">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        @elseif($statusAtual == "9")
        <svg id="svg-vertical5">
        ...
        <svg id="svg-vertical5Complemento">
            <line x1="0" y1="0" x2="118" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        {{-- <svg id="svg-verticalRev"><line x1="0" y1="0" x2="60" y2="0" style="stroke:blue;stroke-width:5" /></svg> --}}
        <svg id="svg-horizontal7">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        ...
        <svg id="svg-vertical5Complemento">
            <line x1="0" y1="0" x2="118" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        {{-- <svg id="svg-verticalRev"><line x1="0" y1="0" x2="60" y2="0" style="stroke:blue;stroke-width:5" /></svg> --}}
        <svg id="svg-horizontal7">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        ...
        <svg id="svg-vertical7">
            <line x1="0" y1="0" x2="30" y2="0" style="stroke:#F8C602;stroke-width:5" />
        </svg>
        <svg height="5" id="svg-horizontal9" width="400">
            <line x1="0" y1="0" x2="372" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        {{-- <svg height="5" id="svg-horizontal20"><line x1="0" y1="0" x2="100" y2="0" style="stroke:#bbbbbb60;stroke-width:5" /></svg> --}}
        <svg id="svg-vertical8">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        ...
        <svg id="svg-vertical7">
            <line x1="0" y1="0" x2="30" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg height="5" id="svg-horizontal9" width="400">
            <line x1="0" y1="0" x2="372" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        <svg id="svg-vertical7">
            <line x1="0" y1="0" x2="33" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg height="5" id="svg-horizontal9" width="400">
            <line x1="0" y1="0" x2="372" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        <svg height="5" id="svg-horizontal9" width="400">
            <line x1="0" y1="0" x2="372" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        {{-- <svg height="5" id="svg-horizontal20"><line x1="0" y1="0" x2="100" y2="0" style="stroke:#bbbbbb60;stroke-width:5" /></svg> --}}
        <svg id="svg-vertical8">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        ...
        <svg id="svg-vertical7">
            <line x1="0" y1="0" x2="33" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg height="5" id="svg-horizontal9" width="400">
            <line x1="0" y1="0" x2="372" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        <div class="event8" id="event8">
            ...
            <svg id="svg-horizontalProgPagamento">
                <line x1="0" y1="0" x2="139" y2="0" style="stroke:#bbbbbb60;stroke-width:5;" />
            </svg>
        </div>
        @endif
        ...
        @if($statusAtual == "12")
        <svg id="svg-vertical10">
            <line x1="0" y1="0" x2="43" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <!--Se já foi pago -->
        @elseif($statusAtual == "9")
        <svg id="svg-vertical10">
        ...
        @elseif($statusAtual == "14")
        <svg id="svg-vertical10">
            <line x1="0" y1="0" x2="43" y2="0" style="stroke:#F8C602;stroke-width:5" />
        </svg>
        @else
        <svg id="svg-vertical10">
            <line x1="0" y1="0" x2="43" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        @endif
        ...
        <div class="event12" id="event12" data-toggle="tooltip" data-placement="left">
            ...
            <svg id="svg-verticalComprovantePag">
                <line x1="0" y1="0" x2="35" y2="0" style="stroke:#F8C602;stroke-width:5" />
            </svg>
        </div>
        @elseif($statusAtual == "11")
        <div class="event12" id="event12" data-toggle="tooltip" data-placement="left">
            ...
            <svg id="svg-verticalComprovantePag">
                <line x1="0" y1="0" x2="35" y2="0" style="stroke:green;stroke-width:5" />
            </svg>
        </div>
        @else
        <div class="event12" id="event12" data-toggle="tooltip" data-placement="left">
            ...
            <svg id="svg-verticalComprovantePag">
                <line x1="0" y1="0" x2="35" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
            </svg>
        </div>
        @endif
        ...
        <!--Solicitação paga -->
        @if($statusAtual == "9")
        <svg id="svg-vertical11">
            <line x1="0" y1="0" x2="26" y2="0" style="stroke:green;stroke-width:5" />
        </svg>

        <div class="event13" id="event13" data-toggle="tooltip" data-placement="left">

            <div class="event14Bubble" style="margin-top: -4.8em; display:block;">
                <svg id="svg-horizontalInicio">
                    <line x1="0" y1="0" x2="600" y2="0" style="stroke:green;stroke-width:5" />
                </svg>
            </div>
        ...
        @else
        <svg id="svg-vertical11">
            <line x1="0" y1="0" x2="26" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        ...
        @if($statusAtual == "13")
        <div class="event10" id="event10" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação foi cancelada.">
            <div class="event10Bubble" style="background-color: green;">
            </div>
        </div>
        <svg id="svg-vertical12">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        @else
        <div class="event10" id="event10" data-toggle="tooltip" data-placement="left"
            title="Sua solicitação não está cancelada.">
        ...
        @if($statusAtual == "8")
        <svg id="svg-horizontal12">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        <svg id="svg-vertical12" style="margin-left:-895px;">
            <line x1="0" y1="0" x2="25" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>
        <svg id="svg-horizontal13">
            <line x1="0" y1="0" x2="133" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        @elseif($statusAtual == "10")
        <svg id="svg-horizontal12">
            <line x1="0" y1="0" x2="0" y2="0" style="stroke:white;stroke-width:5" />
        ...
        <svg id="svg-vertical12" style="margin-left:-895px;">
            <line x1="0" y1="0" x2="25" y2="0" style="stroke:green;stroke-width:5" />
        </svg>
        <svg id="svg-horizontal13">
            <line x1="0" y1="0" x2="133" y2="0" style="stroke:white;stroke-width:5" />
        </svg>
        ...
        <p style="margin-left: 490px; margin-top: 300px; margin-right: 20px;">Sim</p>

        <p style="margin-left: -140px; margin-top: 300px; margin-right: 10px;">Não</p>

        <p style="margin-left: -569px; margin-top: 70px; margin-right: 30px;">Solicitação Validada ?</p>

        <p style="margin-left: 329px; margin-top: 400px; margin-right: 47px;">Solicitação Aprovada ?</p>
        ...
        <p style="margin-left: -425px; margin-top: -92px;">Início</p>

        <svg id="svg-horizontalLegenda3">
            <line x1="0" y1="0" x2="25" y2="0" style="stroke:#bbbbbb60;stroke-width:5" />
        </svg>

        <svg id="svg-horizontalLegenda1">
            <line x1="0" y1="0" x2="25" y2="0" style="stroke:green;stroke-width:5" />
        </svg>

        <svg id="svg-horizontalLegenda2">
            <line x1="0" y1="0" x2="25" y2="0" style="stroke:#F8C602;stroke-width:5" />
        </svg>
