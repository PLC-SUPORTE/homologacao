...
@section('title') Solicitações de reembolso histórico @endsection <!-- Titulo da pagina -->
...
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Financeiro.Reembolso.Financeiro.index') }}">Solicitações de reembolso em andamento</a>
</li>
<li class="breadcrumb-item active" style="color: black;">Solicitações de reembolso finalizadas
</li>
@endsection
...
<a href="{{ route('Painel.Financeiro.Reembolso.Financeiro.index') }}" class="waves-light btn tooltipped" style="color: white; background-color: gray; font-size: 11px; border-radius: 50px;" data-position="left" data-tooltip="Clique aqui para visualizar suas solicitações em andamento."><i class="material-icons left">arrow_back</i>Voltar</a>  
  </div>
