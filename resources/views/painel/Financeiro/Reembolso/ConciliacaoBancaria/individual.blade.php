...
<?php $search = 2 ?>
@section('title') Baixar solicitação de reembolso @endsection
<!-- Titulo da pagina -->
                ...
                <div class="container">
                    ...
                    <section class="invoice-edit-wrapper section">
                        ...
                        <form role="form" id="form"
                            action="{{ route('Painel.Financeiro.Reembolso.ConciliacaoBancaria.individual_store') }}"
...
height:100%;" src="{{ route('Painel.Financeiro.Reembolso.anexos', $datas->NumeroDebite) }}"></iframe>
                                            ...
                                            <div class="invoice-item display-flex mb-1">
                                                <div class="invoice-item-filed row pt-1">
                                                    ...
                                                    <div class="col m2 s12 input-field">
                                                        <span style="font-size: 11px;">Data do serviço:</span>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea readonly id="observacao" rows="3" type="text"
                                                                    ...
                                                                    style="height: 8rem;text-align:left; overflow:auto;font-size: 10px;">{{$datas->Observacao}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row" style="font-size:10px;" id="aprovadiv">
                                                ...
                                                <div class="input-field col m12 s12">
                                                    ...
                                                    <div class="form-group bmd-form-group is-filled">
                                                        <input style="font-size: 10px;" type="date"
                                                            name="dataconciliacao" id="dataconciliacao"
                                                            value="{{$datahoje}}" max="{{$datahoje}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-field col m12 s12">
                                                    ...
                                                    <div class="form-group bmd-form-group is-filled">
                                                        <input style="font-size: 10px;" type="date" name="databaixa"
                                                            id="databaixa" value="{{$datahoje}}" max="{{$datahoje}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="input-field col m12 s12">
                                                    ...
                                                    <div class="form-group bmd-form-group is-filled">
                                                        <select class="browser-default"
                                                            style="width: 100%;font-size:10px;" id="gerarcpr"
                                                            name="gerarcpr" data-toggle="tooltip" data-placement="top"
                                                            title="Selecione se deseja gerar a CPR pro cliente neste momento.">
                                                ...
                                                <div class="input-field col m12 s12">
                                                    ...
                                                    <div class="form-group bmd-form-group is-filled">
                                                        <select class="browser-default"
                                                            style="width: 100%;font-size:10px;" id="tipodoc"
                                                            name="tipodoc" data-toggle="tooltip" data-placement="top"
                                                ...
                                                <div class="input-field col m12 s12">
                                                    ...
                                                    <div class="form-group bmd-form-group is-filled">
                                                        <select class="browser-default"
                                                            style="width: 100%;font-size:10px;" id="portador"
                                                            name="portador" data-toggle="tooltip" data-placement="top"
                                                            title="Selecione o banco de saída.">
                                                ...
                                                <div class="col s12 m12 l12">
                                                    <label style="font-size: 11px;color:black;">Selecione o comprovante
                                                        de pagamento:</label><br>
                                            ...
                                            <div class="invoice-action-btn">
                                                <a onClick="abreconfirmacao();"
                                                    ...
                                                    <span class="responsive-text" id="btngravar">Baixar
                                                        solicitação</span>
                                                </a>
                                            </div>
            ...
            <div id="aprovar" class="cd-popup" role="alert">
                <div class="cd-popup-container">
                    <p style="font-weight: bold;">Deseja baixar a solicitação de reembolso?</p>
                    <ul class="cd-buttons">
...
{{$datas->Hist}}
Número da solicitação: {{ $datas->NumeroDebite}}. Solicitação de reembolso baixada pelo(a): {{Auth::user()->name}} pela equipe do financeiro. - {{$dataehora}}</textarea>
            </div>
