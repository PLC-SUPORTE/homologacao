...
@section('header')
<title>Solicitações reembolso histórico | Portal PL&C</title>
...
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Financeiro.Reembolso.ConciliacaoBancaria.index') }}">Solicitações
        em andamento</a>
</li>
                    ...
                    <div class="section">
                        ...
                        <section class="invoice-list-wrapper section">
                            ...
                            <div class="invoice-filter-action mr-3">
                                <a href="{{ route('Painel.Financeiro.Reembolso.ConciliacaoBancaria.index') }}"
