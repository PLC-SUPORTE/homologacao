...
@section('title') Solicitações reembolso @endsection <!-- Titulo da pagina -->
...
@section('header') 
    ...
    <title>Solicitações reembolso | Portal PL&C</title>
...
<div class="invoice-filter-action mr-3">
  <a href="{{ route('Painel.Financeiro.Reembolso.ConciliacaoBancaria.historico') }}" class="waves-light btn" style="color: white; background-color: gray; font-size: 11px; border-radius: 50px;">
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      @foreach($datas as $data)  
        <tr>
          ...
          <a href="{{route('Painel.Financeiro.Reembolso.ConciliacaoBancaria.solicitacoessocio', $data->SolicitanteCodigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="left" data-tooltip="Clique aqui para visualizar as solicitações aguardando o pagamento deste sócio."><i class="material-icons">assignment</i></a>
          </div>
          </td>
