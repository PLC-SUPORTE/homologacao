...
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Financeiro.Reembolso.Revisao.index') }}">Solicitações em
        andamento</a>
</li>
...
@section('body')
    <div>
        <div id="loadingdiv" style="display:none;margin-top: 200px; margin-left: 570px;">
            ...
            <h6 style="font-size: 20px;margin-left:-190px;">Aguarde, estamos atualizando a solicitação de reembolso...
            </h6>
        </div>
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <section class="invoice-edit-wrapper section">
                        ...
                        <form role="form" id="form" action="{{ route('Painel.Financeiro.Reembolso.Revisao.revisado') }}"
...
height:100%;" src="{{ route('Painel.Financeiro.Reembolso.anexos', $datas->NumeroDebite) }}"></iframe>
                            ...
                            <div class="row" style="padding: 5px;">
                                            ...
                                            <div class="invoice-item display-flex mb-1">
                                                <div class="invoice-item-filed row pt-1">
                                                    ...
                                                    <div class="col m2 s12 input-field">
                                                        ...
                                                        <input type="text" readonly
                                                            value="R$ <?php echo number_format($datas->ValorUnitario,2,",",".") ?>"
                                                    ...
                                                    <div class="col m2 s12 input-field">
                                                        ...
                                                        <input type="text" readonly
                                                            value="R$ <?php echo number_format($datas->Valor,2,",",".") ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col xl3 m4 s12" style="margin-top: -12px;">
                                        <div class="card invoice-action-wrapper mb-10">
                                            <div class="card-content">

                                                <h6 style="font-size: 11px;" class="card-title">Workflow - Solicitação
                                                    de reembolso </h6>
                                                ...
                                                <ul class="widget-timeline mb-0">
                                                    ...
                                                    <li class="timeline-items timeline-icon-green active">
                                                        ...
                                                        <h6 class="timeline-title" style="font-size: 9px;color:black;">
                                                            <?php echo mb_convert_case($datas->SolicitanteNome, MB_CASE_TITLE, "UTF-8")?>
                                                        </h6>
                                                        <p class="timeline-text" style="font-size: 11px;color:black;">
                                                            Solicitação criada</p>
                                                    </li>
                                                    ...
                                                    <li class="timeline-items timeline-icon-yellow active">
                                                        <div class="timeline-time"
                                                            style="font-size: 8.5px;color:black;">
                                                            {{ date('d/m/Y H:i', strtotime($historico->data)) }}</div>
                                                        <h6 class="timeline-title" style="font-size: 9px;color:black;">
                                            ...
                                            <li>
                                                ...
                                                <div class="collapsible-body">
                                                    <table id="scroll-dynamic" class="display">
                                                        <thead>
                                                            <tr>
                                                                <th style="font-size: 11px;color:black">Tipo despesa
                                                                </th>
...
{{$datas->Hist}}
Número da solicitação: {{$datas->NumeroDebite}}. Solicitação de reembolso revisada pelo(a): {{Auth::user()->name}} na Revisão Técnica - {{$dataehora}}</textarea>
                </div>


                <div class="input-field col s12" style="display: none">
                    <textarea id="histreprovada" rows="4" type="text" name="histreprovada" readonly=""
                        class="form-control" style="text-align: left;margin: 0;" placeholder="Hist debite">
{{$datas->Hist}}
Número da solicitação: {{$datas->NumeroDebite}}. Solicitação de reembolso reprovada pelo(a): {{Auth::user()->name}} na Revisão Técnica - {{$dataehora}} com o motivo: </textarea>
                </div>


                <div class="input-field col s12" style="display: none">
                    <textarea id="histcancelada" rows="4" type="text" name="histcancelada" readonly=""
                        class="form-control" style="text-align: left;margin: 0;" placeholder="Hist debite">
{{$datas->Hist}}
Número da solicitação: {{$datas->NumeroDebite}}. Solicitação de reembolso cancelada pelo(a): {{Auth::user()->name}} na Revisão Técnica - {{$dataehora}} com o motivo: </textarea>
                </div>
