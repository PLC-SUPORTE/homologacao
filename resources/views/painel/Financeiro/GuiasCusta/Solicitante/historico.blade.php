...
@section('submenu')
<li class="breadcrumb-item"><a href="{{ route('Painel.Financeiro.GuiasCustas.Solicitante.index') }}">Solicitações em andamento</a>
</li>
                  ...
                  <div class="section">
                     <section class="invoice-list-wrapper section">
                        <div class="invoice-filter-action mr-3">
                              ...
                              <a href="{{ route('Painel.Financeiro.GuiasCustas.Solicitante.index') }}" class="waves-light btn" style="color: white; background-color: gray; font-size: 11px; border-radius: 50px;">
