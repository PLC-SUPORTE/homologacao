...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Solicitação de guia de custa anexos | Portal PL&C</title>
...
<body data-open="click" data-menu="vertical-modern-menu" data-col="2-columns" style="overflow: hidden;">
 ...
 <!-- BEGIN: Page Main-->
          ...
          <div class="collection file-manager-drive mt-3">
            ...
            <a href="#modalimportaarquivo"  class="collection-item file-item-action modal-trigger" >
              ...
              <span style="color: black;">Adicionar anexo</span>
                        ...
                        <form id="form" role="form" onsubmit="btnsubmit.disabled = true; return true;" action="{{ route('Painel.Financeiro.GuiasCusta.importaranexos') }}" method="POST" role="create" enctype="multipart/form-data" >
                        {{ csrf_field() }}
  ...
  <div id="anexos{{$data->Arq_nick}}" class="modal modal-fixed-footer" style="width: 100%;height:100%;overflow:hidden;">
      ...
      <iframe src="https://docs.google.com/gview?url=https://portal.plcadvogados.com.br/portal/public/imgs/reembolso/{{$data->Arq_nick}}&embedded=true" style="width:900px;height:1200px;" scrolling="no" frameborder="0" allowfullscreen></iframe> 
          ...
          <a href="#anexos{{$data->Arq_nick}}" class="modal-trigger">
              ...
              <div class="card-content">
                ...
                <div class="app-file-recent-details">
                  <div class="app-file-name" style="font-size: 10px;color:#6b6f82;">{{$data->Arq_nick}}</div>
