...
<section class="invoice-list-wrapper section">
  ...
  <a href="{{ route('Painel.Financeiro.GuiasCustas.Revisao.historico') }}" class="waves-light btn" style="color: white; background-color: gray; font-size: 11px; border-radius: 50px;">
...
<!--Fim Modal Anexos --> 
        ...
        @if($data->StatusID == 1)
        <a href="{{route('Painel.Financeiro.GuiasCustas.Revisao.revisar', $data->NumeroDebite)}}" class="invoice-action-view mr-4 tooltipped modal-trigger" data-position="bottom" data-tooltip="Clique aqui para revisar está solicitação de pagamento de guia de custa."><i class="material-icons">remove_red_eye</i></a>
        @endif
