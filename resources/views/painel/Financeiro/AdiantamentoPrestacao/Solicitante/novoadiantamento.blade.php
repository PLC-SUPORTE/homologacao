...
<form role="form" id="form" action="{{ route('Painel.Financeiro.AdiantamentoPrestacao.Solicitante.novoadiantamento_store') }}" method="POST" role="search" enctype="multipart/form-data" >
  {{ csrf_field() }}
  ...
  <div id="loadingdiv2" style="display:none;margin-top: 300px; margin-left: 570px;">
    ...
    <h6 style="font-size: 20px;margin-left:-180px;">Aguarde, estamos guardando este novo adiantamento...</h6>
  </div>
  ...
  <div class="row" id="div_all">
    ...
    <div class="col xl9 m8 s12">
      ...
      <div class="input-field col s6" id="umclientediv">
        ...
        <div class="card-content">
          ...
          <div class="invoice-action-btn">
            <a id="btnsubmit" onClick="abremodalconfirmacao();" style="background-color: gray;color:white;font-size:11px;" class="btn waves-effect waves-light display-flex align-items-center justify-content-center">
              ...
              <span class="responsive-text">Solicitar adiantamento</span>
            </a>
          </div>
...
<div id="alertaconfirmacao" name="alertaconfirmacao" class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Deseja solicitar um adiantamento?</p>
		<ul class="cd-buttons">
