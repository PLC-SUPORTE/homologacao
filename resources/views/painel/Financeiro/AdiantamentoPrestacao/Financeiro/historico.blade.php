...
@section('title') Solicitações de adiantamento finalizadas @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item"><a href="{{ route('Painel.Financeiro.AdiantamentoPrestacao.Financeiro.solicitacoesadiantamento', $usuario_cpf) }}">Solicitações em andamento</a>
</li>
<li class="breadcrumb-item active" style="color: black;">Solicitações de adiantamento finalizadas
</li>
@endsection
...
<div class="invoice-filter-action mr-3">
   <a href="{{ route('Painel.Financeiro.AdiantamentoPrestacao.Financeiro.solicitacoesadiantamento', $usuario_cpf) }}" class="waves-light btn" style="color: white; background-color: gray; font-size: 11px; border-radius: 50px;">
