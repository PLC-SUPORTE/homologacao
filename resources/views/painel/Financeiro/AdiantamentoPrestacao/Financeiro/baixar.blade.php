...
<?php $search = 2 ?>
@section('title') Baixar solicitação de prestação de conta @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Baixar solicitação de prestação de conta
</li>
@endsection
...
@section('body')
  ...
  <h6 style="font-size: 20px;margin-left:-170px;">Aguarde, estamos baixando a prestação de conta...</h6>
  </div>
...
<form role="form" id="form" action="{{ route('Painel.Financeiro.AdiantamentoPrestacao.Financeiro.baixado') }}" method="POST" role="search" enctype="multipart/form-data" >
  {{ csrf_field() }}
...
Número da solicitação: {{$debite->NumeroDebite}}. Prestação de conta no valor de: R$ <?php echo number_format($debite->Valor,2,",",".") ?>  cancelada pelo(a): {{Auth::user()->name}} pela equipe do financeiro - {{$dataehora}} com o motivo: </textarea>
    ...
    <div class="col xl3 m4 s12">
      <div class="card invoice-action-wrapper mb-10">
        ...
        @if($datas->anexo_comprovantedevolucao != null)
        <div id="valordevolvidodiv">

        <p style="font-size: 11px">O usuário prestou conta de um valor menor que o transferido pela PL&C. Você confirma o recebimento do valor não utilizado?</p>
        <p>
        <label>
        <input style="font-size: 11px;" name="valordevolvido" class="with-gap" value="SIM" type="radio" onClick="abreconfirmacaodevolucao();"/>
        ...
        <p>
        <label>
        <input style="font-size: 11px;" name="valordevolvido" class="with-gap" value="NAO" type="radio" checked onClick="fechaconfirmacaodevolucao();"/>
        ...
        <div id="confirmacaodevolucaodiv" style="display: none;">

        <div class="row">
        <div class="input-field col m12 s12">
        <span style="font-size: 10px;">Confirme o banco de recebimento:</span>
        <select class="browser-default" style="width: 100%;font-size:10px;" id="bancodevolucao" name="bancodevolucao"  data-toggle="tooltip" data-placement="top" title="Selecione o banco da PL&C de onde o solicitante devolvei o valor não utilizado.">
        ...
        <div class="input-field col m12 s12">
        <span style="font-size: 10px;">Confirme a data de conciliação:</span>
        <input style="font-size: 10px;" type="date" max="{{$datahoje}}" name="datadevolucao" id="datadevolucao" value="{{$datahoje}}">
        </div>
        ...
        <div class="input-field col m12 s12">
        <span style="font-size: 10px;">Selecione o tipo de lançamento:</span>
        ...
        <div class="input-field col m12 s12">
        <span style="font-size: 10px;">Selecione o tipo de documento:</span>
         <div class="form-group bmd-form-group is-filled">
          <select class="browser-default" style="width: 100%;font-size:10px;" id="tipodoc" name="tipodoc"  data-toggle="tooltip" data-placement="top" title="Selecione o tipo de documento.">
        ...
        <div class="invoice-action-btn">
            <a onClick="abreconfirmacao();" style="background-color: gray;color:white;font-size:11px;" class="btn waves-effect waves-light display-flex align-items-center justify-content-center">
              ...
              <span class="responsive-text" id="btngravar">Baixar prestação</span>
            </a>
        </div> 
  ...
  <div id="aprovar" class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Deseja baixar a solicitação de prestação de conta?</p>
		<ul class="cd-buttons">
