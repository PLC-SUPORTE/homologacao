...
<?php $search = 2 ?>
@section('title') Revisar solicitação de adiantamento @endsection <!-- Titulo da pagina -->
...
<form role="form" id="form" action="{{ route('Painel.Financeiro.AdiantamentoPrestacao.Financeiro.revisado') }}" method="POST" role="search" enctype="multipart/form-data" >
  {{ csrf_field() }}
...
<!--Fim Modal Anexos --> 
  ...
  <div id="aprovar" class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Deseja aprovar a solicitação de adiantamento?</p>
		<ul class="cd-buttons">
...
<div id="reprovar" class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Deseja reprovar a solicitação de adiantamento?</p>
		<ul class="cd-buttons">
    <li><a href="#" onClick="nao();" style="font-weight: bold;">Não</a></li>
			<li><a href="#" onClick="sim();" style="font-weight: bold;">Sim</a></li>
		</ul>
...
<div id="cancelar" class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Deseja cancelar a solicitação de adiantamento?</p>
		<ul class="cd-buttons">
    <li><a href="#" onClick="nao();" style="font-weight: bold;">Não</a></li>
			<li><a href="#" onClick="sim();" style="font-weight: bold;">Sim</a></li>
		</ul>
