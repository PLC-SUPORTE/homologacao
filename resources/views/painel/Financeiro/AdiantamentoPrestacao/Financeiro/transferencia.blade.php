...
<?php $search = 2 ?>
@section('title') Transferência de valor @endsection <!-- Titulo da pagina -->
...
@media only screen and (min-width: 1170px) {
  .cd-popup-container {
    ...
    <li class="breadcrumb-item active" style="color: black;">Transferência de solicitação de adiantamento
    </li>
    @endsection
...
<h6 style="font-size: 20px;margin-left:-170px;">Aguarde, estamos atualizando a solicitação de reembolso...</h6>
</div>
...
<!--Fim Modal Anexos --> 
  ...
  <div class="row"  style="padding: 5px;">
      ...
      <a href="#anexos{{$datas->id}}" class="btn-floating btn-mini waves-effect waves-light tooltipped modal-trigger"data-position="left" data-tooltip="Clique aqui para visualizar os anexos."  style="margin-left: 885px;margin-top:-10px;background-color: gray;"><i class="material-icons">attach_file</i></a>
        ...
        <div class="card-content px-36">
           ...
           <div class="row invoice-info">
            <div class="col m4 s4">
              <h6 class="invoice-from">Dados da solicitação</h6>
            ...
            <div class="col m4 s4">
              <h6 class="invoice-from">Dados bancários do solicitante</h6>
    ...
    <div class="col xl3 m4 s12">
      <div class="card invoice-action-wrapper mb-10">
        ...
        <span style="font-size: 11px;">Data de competência:</span>
        ...
        <div class="input-field col m12 s12">
        <span style="font-size: 11px;">Tipo de lançanmento:</span>
        <div class="form-group bmd-form-group is-filled">
        ...
        <div class="input-field col m12 s12" style="display: none;">
          <span style="font-size: 10px;">Selecione o comprovante da transferência:</span>
        ...
        <div class="invoice-action-btn">
            <a onClick="abreconfirmacao();" style="background-color: gray;color:white;font-size:11px;" class="btn waves-effect waves-light display-flex align-items-center justify-content-center">
              ...
              <span class="responsive-text" id="btngravar">Atualizar solicitação</span>
            </a>
        </div> 
  ...
  <div id="aprovar" class="cd-popup" role="alert">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Deseja atualizar a solicitação de adiantamento?</p>
		<ul class="cd-buttons">
