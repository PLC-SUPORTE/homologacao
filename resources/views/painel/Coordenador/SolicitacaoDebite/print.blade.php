            ...
            <tr>
             ...
             <td>R$ {{$numeroprocesso->ValorTotal}}</td>
              ...
              <div class="row no-print">
                <div class="col-12">
                  @if(!empty($anexoformatado))
                  <a href="{{route('Painel.Coordenador.anexo',$anexoformatado)}}" class="delete"><span class="btn btn-success float-right fa fa-print">&nbsp;&nbsp;Download Anexo</span></a>
                  @endif
