...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Perfís | Portal PL&C</title>
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('perfis.create') }}" class="btn waves-effect waves-light invoice-create border-round z-depth-4" style="background-color: gray">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Novo perfíl</span>
    </a>
  </div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th style="font-size: 12px">Usuários</th>
          <th style="font-size: 12px"></th>
        </tr>
      </thead>
      ...
      @foreach($data as $profile)
        <tr>
          ...
          <td style="font-size: 11px"></td>
          <td style="font-size: 11px"></td>
          <td style="font-size: 11px">{{ $profile->id }}</td>
          <td style="font-size: 11px">{{ $profile->name }}</td>
          <td style="font-size: 11px">{{ $profile->label }}</td>

          <td style="font-size: 11px">
          <div class="invoice-action">
          <a href="{{route('perfis.edit', $profile->id)}}" class="invoice-action-view mr-4"><i class="material-icons">edit</i></a>
          </div>
          </td>         
          
          <td style="font-size: 11px">
          <div class="invoice-action">
          <a href="{{route('profile.users', $profile->id)}}" class="invoice-action-view mr-4"><i class="material-icons">person</i></a>
          </div>
          </td>
          <td style="font-size: 11px"></td>
