...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Salvar profíle | Portal PL&C</title>
        ...
        <nav class="navbar-main navbar-color nav-collapsible navbar-dark no-shadow" style="background-color: gray">
          <div class="nav-wrapper">
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -50px;">
              <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span style="color: white;">Salvar perfíl</span></h5>
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item" style="color: black;">Salvar perfíl</a>
                </li>
              </ol>
          </div>
 ...
 <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ asset('/public/AdminLTE/img/Avatar/img.png') }}" class="img-circle" alt="User Image"><i></i></span></a></li>            </ul>
  ...
  <div id="loadingdiv" style="display:none">
     ...
     <h1 style="text-align: center;">Aguarde, estamos salvando o perfíl...&hellip;</h1>
     </div>
  </center>   
                    ...
                    <div id="Form-advance" class="card card card-default scrollspy">
                      ...
                      @if( isset($data) )
                      {!! Form::model($data, ['route' => ['perfis.update', $data->id], 'class' => 'form form-search form-ds', 'id' => 'form', 'method' => 'PUT']) !!}
                      @else
                      {!! Form::open(['route' => 'perfis.store', 'class' => 'form form-search form-ds', 'id' => 'form']) !!}
                      @endif
                          ...
                          <div class="row">
                            ...
                            <div class="input-field col m4 s12">
                                <span>Perfíl:</span>
                                {!! Form::text('name', null, ['placeholder' => 'Perfíl:', 'class' => 'form-control']) !!}
                            </div>
                          ...
                          <div class="right-align">
                            <a class="btn red" href="{{url('/painel/perfis')}}"><i class="material-icons left">close</i>Cancelar</a>
