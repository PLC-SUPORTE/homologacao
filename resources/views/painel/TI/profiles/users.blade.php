...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Usuários relacionados | Portal PL&C</title>
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{route('profile.users.add', $profile->id)}}" class="btn waves-effect waves-light invoice-create border-round z-depth-4" style="background-color: gray">
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th style="font-size: 12px">Perfíl</th>
          <th style="font-size: 12px">Deletar</th>
          <th style="font-size: 12px"></th>
        </tr>
      </thead>
      ...
      @forelse($users as $user)
        <tr>
          ...
          <a href="{{route('profile.user.delete', [$profile->id, $user->id])}}" class="invoice-action-view mr-4"><i class="material-icons">delete</i></a>
          </div>
          </td>         
