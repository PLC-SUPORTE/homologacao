...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Solicitações - Pesquisa Patrimonial</title>
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="{{ route('Painel.TI.agendamentomesa.restrito.create', $sala_id) }}" class="btn waves-effect waves-light invoice-create border-round z-depth-4" style="background-color: gray">
      <i class="material-icons">add</i>
      <span class="hide-on-small-only">Nova mesa</span>
    </a>
  </div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      @foreach($datas as $data)  
        <tr>
          ...
          <td style="font-size: 11px">{{ $data->Sala }}</td>
          <td style="font-size: 11px">{{ $data->Andar}}</td>
          <td style="font-size: 11px">{{ $data->Unidade}}</td>
          <td style="font-size: 11px"><span class="bullet green"></span> Não ocupado</td>
          <td style="font-size: 11px">
      
          <div class="invoice-action">
          <a href="{{ route('Painel.TI.agendamentomesa.restrito.mesas.agenda', $data->id) }}" class="invoice-action-view mr-4"><i class="material-icons">remove_red_eye</i></a>
          </div>
