...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/css/fullcalendar.min.css">
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/daygrid/daygrid.min.css">
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/timegrid/timegrid.min.css">
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/pages/app-calendar.min.css">
          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6 breadcrumbs-left">
                <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span>Agenda</span></h5>
                <ol class="breadcrumbs mb-0">
                  <li class="breadcrumb-item"><a href="{{ route('Home.Principal.Show') }}">Home</a>
                  </li>
                  <li class="breadcrumb-item"><a href="#">Mesas</a>
                  </li>
...
<div id="app-calendar">
  <div class="row">
    ...
    <!-- <script src="{{ asset('/public/materialize/js/fullcalendar.min.js') }}"></script> -->


    <script src="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/lib/moment.min.js"></script>
    <script src="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/js/fullcalendar.min.js"></script>
    <script src="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/daygrid/daygrid.min.js"></script>
    <script src="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/timegrid/timegrid.min.js"></script>
    <script src="https://pixinvent.com/materialize-material-design-admin-template/app-assets/vendors/fullcalendar/interaction/interaction.min.js"></script>
    ...
    <script src="https://pixinvent.com/materialize-material-design-admin-template/app-assets/js/scripts/app-calendar.min.js"></script>
