...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Dashboard - Pesquisa Patrimonial</title>
    ...
    <link rel="stylesheet" href="asset('https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/pages/charts-sparkline.min.css">

    <link rel="stylesheet" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/pages/dashboard.min.css">
 ...
 <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="{{ asset('/public/AdminLTE/img/Avatar/img.png') }}" class="img-circle" alt="User Image"><i></i></span></a></li>            </ul>
            ...
            <div class="nav-wrapper">
              ...
              {{ csrf_field() }}
                <div class="input-field search-input-sm">
                  <input class="search-box-sm mb-0" type="search" id="search2" placeholder="Buscar pesquisado" data-search="template-list">
    ...
    <ul class="display-none" id="page-search-title">
      <li class="auto-suggestion-title"><a class="collection-item" href="#">
          <h6 class="search-title">PESQUISADOS</h6></a></li>
    </ul>
    <ul class="display-none" id="search-not-found">
      <li class="auto-suggestion"><a class="collection-item display-flex align-items-center" href="#"><span class="material-icons">error_outline</span><span class="member-info">Nenhum registro encontrado.</span></a></li>
    </ul>
    ...
    <div id="main">
      <div class="row">
        ...
        <div class="col s12">
          ...
          <div class="card tooltipped"  data-position="top" data-tooltip="Total de agendamentos para as estações de trabalho marcados na data de hoje." >
               <div class="card-content cyan white-text">
               <p class="card-stats-title" style="font-size: 12px">Agendamentos para hoje</p>
               <p style="font-size: 10px">Estações de trabalho</p>
                  <h4 class="card-stats-number white-text">{{$QuantidadeAgendamentosHojeEstacoes}}</h4>
         ...
         <div class="col s6 m4 l2 x4">
          <div class="card tooltipped"  data-position="top" data-tooltip="Total de agendamentos para as salas de reunião marcados na data de hoje." >
               <div class="card-content cyan white-text">
               <p class="card-stats-title" style="font-size: 12px">Agendamentos para hoje</p>
               <p style="font-size: 10px">Salas de reunião</p>
                  <h4 class="card-stats-number white-text">{{$QuantidadeAgendamentosHojeReuniao}}</h4>
                  <p class="card-stats-compare">
                  </p>
               </div>
            </div>
          ...
          <div class="col s6 m4 l2 x4">
          <div class="card tooltipped"  data-position="top" data-tooltip="Total de agendamentos criados no portal." >
               <div class="card-content cyan white-text">
               <p class="card-stats-title" style="font-size: 12px">Total de agendamentos</p>
                  <h4 class="card-stats-number white-text">{{$QuantidadeAgendamentosTotal}}</h4>
                  <p class="card-stats-compare">
                  </p>
               </div>
            </div>
         ...
         <div class="col s6 m4 l2 x4">
         <div class="card tooltipped"  data-position="top" data-tooltip="Quantidade total de andares cadastrados no portal." >
               <div class="card-content cyan white-text">
                  <p class="card-stats-title" style="font-size: 12px">Quantidade andares</p>
                  <h4 class="card-stats-number white-text">{{$QuantidadeAndares}}</h4>
                  <p class="card-stats-compare">
                  </p>
               </div>
            </div>
         ...
         <div class="col s6 m4 l2 x4">
            <div class="card tooltipped"  data-position="top" data-tooltip="Quantidade de salas cadastradas no portal." >
               <div class="card-content cyan white-text">
               <p class="card-stats-title" style="font-size: 12px">Quantidade salas</p>
                  <h4 class="card-stats-number white-text">{{$QuantidadeSalas}}</h4>
                  <p class="card-stats-compare">
                  </p>
               </div>
            </div>
         ...
         <div class="col s6 m4 l2 x4">
            <div class="card tooltipped"  data-position="top" data-tooltip="Quantidade de estações de trabalho cadastradas no portal." >
               <div class="card-content cyan white-text">
               <p class="card-stats-title" style="font-size: 12px">Quantidade estações</p>
                  <h4 class="card-stats-number white-text">{{$QuantidadeEstacoes}}</h4>
                  <p class="card-stats-compare">
                  </p>
               </div>
            </div>
  ...
  <div class="col s12 m6 l6">
            <ul id="issues-collection" class="collection z-depth-1 animate fadeRight">
               <li class="collection-item avatar">
                  <i class="material-icons red accent-2 circle">error_outline</i>
                  <h6 class="collection-header m-0">Acompanhar</h6>
                  <p>Acompanhar status agendamento</p>
               </li>

               <li class="collection-item">
                  <div class="row">
                     <div class="col s7">
                        <p class="collections-title">Agendadas</p>
                     </div>
                     <div class="col s2"><span class="task-cat deep-orange accent-2">{{$QuantidadeAgendadas}}</span></div>
                     <div class="col s3">
                        <div class="progress">
               ...
               <li class="collection-item">
                  <div class="row">
                     <div class="col s7">
                     <p class="collections-title">Aguardando check-in</p>
                     </div>
                     <div class="col s2"><span class="task-cat deep-orange accent-2">{{$QuantidadeAguardandoCheckIn}}</span></div>
                     <div class="col s3">
                        <div class="progress">
                        <div class="determinate" style="width: 0%"></div>
                        </div>
               ...
               <li class="collection-item">
                  <div class="row">
                     <div class="col s7">
                     <p class="collections-title">Check-in feito</p>
                     </div>
                     <div class="col s2"><span class="task-cat deep-orange accent-2">{{$QuantidadeCheckInFeito}}</span></div>
                     <div class="col s3">
                        <div class="progress">
                        <div class="determinate" style="width: 0%"></div>
                        </div>
               ...
               <li class="collection-item">
                  <div class="row">
                     <div class="col s7">
                     <p class="collections-title">Finalizadas</p>
                     </div>
                     <div class="col s2"><span class="task-cat accent-4" style="background-color: green">{{$QuantidadeFinalizadas}}</span></div>
                     <div class="col s3">
                        <div class="progress">
                        <div class="determinate" style="width: 0%"></div>
                        </div>
         ...
         <div class="col s12 m6 l6">
            <ul id="issues-collection" class="collection z-depth-1 animate fadeRight">
               <li class="collection-item avatar">
                  <i class="material-icons red accent-2 circle">error_outline</i>
                  <h6 class="collection-header m-0">Acompanhar</h6>
                  <p>Utilização das salas de reunião</p>
               </li>
               ...
               <li class="collection-item">
                  <div class="row">
                     <div class="col s7">
                        <p class="collections-title">{{$reuniao->Descricao}}</p>
                     </div>
                     <div class="col s2"><span class="task-cat deep-orange accent-2">-</span></div>
                     <div class="col s3">
                        <div class="progress">
                        <div class="determinate" style="width: 0%"></div>
                        </div>
    ...
    <div class="ct-chart card z-depth-2 border-radius-6" style="overflow: auto; max-height: 400px;">
        <div class="card-content">
          ...
          <th style="font-size: 12px">Sala</th>
          <th style="font-size: 12px">Andar</th>
          <th style="font-size: 12px">Unidade</th>
          <th style="font-size: 12px">Data ínicio</th>
          ...
          <th style="font-size: 12px">Ação</th>
                ...
                @foreach($datas as $data)  
                  <tr>
                    ...
                    <td>{{ $data->Andar}}</td>
                    <td>{{ $data->Unidade}}</td>
                    <td>{{ date('d/m/Y H:i:s', strtotime($data->DataInicio)) }}</td>
                    <td>{{ date('d/m/Y H:i:s', strtotime($data->DataFim)) }}</td>
                    <td>{{ $data->Status}}</td>
                    <td>
                    <a href="" class="invoice-action-view mr-4"><i class="material-icons">remove_red_eye</i></a>
                    </td>
                  </tr>
                @endforeach
                </tbody>
    ...
    <script src="{{ asset('/public/materialize/js/chartist.min.js') }}"></script>
