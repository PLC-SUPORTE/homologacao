   ...
   <div id="main">
      <div class="row">
        ...
        <div class="card-content">
            ...
            O PLC, atento às modernizações do mercado corporativo, às ferramentas tecnológicas, às novas formas de trabalho e relacionamento profissional, à experiência exitosa que estamos vivenciando neste home office implementado pelo distanciamento social ocasionado pela COVID-19, aliado ao alto grau de responsabilidade e comprometimento de cada profissional do PLC, implantará uma estrutura de home office definitivo com rodízio para as atividades presenciais (“Home Office Estrutural”) em todas as suas unidades.
            </p>
            <p>A implantação do Home Office Estrutural ocorrerá de forma faseada, da seguinte forma:</p>
            <p>• <strong>Fase 1</strong> - Retorno presencial apenas de parte dos profissionais, em escala de rodízio em dias
alternados durante a semana. O rodízio será realizado em grupos fixos, evitando-se o contato
entre pessoas de grupos diferentes.</p>
            <p>• <strong>Fase 2</strong> - Retorno presencial de todos os profissionais, ainda em escala de rodízio, de acordo com a
escala definida para cada Unidade do PLC.</p>
            <p>• <strong>Fase 3</strong> - Implantação do sistema definitivo de trabalho a partir das informações obtidas durante
...
<section class="invoice-list-wrapper section">
  ...
  <div class="invoice-create-btn">
    <a href="#modal" class="btn waves-effect waves-light invoice-create border-round z-depth-4 btn modal-trigger tooltipped" data-position="left" data-tooltip="Clique aqui para realizar um nova agendamento de estação de trabalho ou sala de reunião." style="background-color: gray">
  ...
  <button type="button" class="btn waves-effect mr-sm-1 mr-2 modal-close red" style="margin-top: -26px; margin-left: 1080px;position: fixed;"><i class="material-icons">close</i></button>
      ...
      <br>
        ...
        <div class="input-field col s2">
          ...
          <label style="font-size: 11px;" for="icon_telephone">Data ínicio:</label>
        </div>
            ...
            <div class="col s2" style="border: 1px solid #7E7D7D; height: 160px; border-radius: 20px;">
              <div class="container" style="margin-top: 50px;">
                ...
                <label>
                  ...
                  <span style="color: black; font-size: 12px;">Estação de trabalho</span>
                </label> 
                
                <br>
  
                <label>
                <input class="with-gap" type="radio" id="salareuniao" name="sala" value="2"/><span style="color: black; font-size: 12px;">Sala de reunião</span>
                </label>
              </div>
              </div>
              ...
              <div style="border: 1px solid #7E7D7D; height: 160px; border-radius: 20px; width: 950px; margin-left: 220px;">
                ...
                style="background-color: gray;color:white; margin-top: -75px; margin-left: 1000px; border-radius: 20px;">Avançar
