        ...
        <section class="content-header">
            ...
            <br>
              <!-- <small>Solicitar nova pesquisa patrimonial:
                   <a type="button" href="{{ route('Painel.PesquisaPatrimonial.solicitacao.create') }}" class="btn btn-sm  btn-success fa fa-plus" data-toggle="tooltip" data-placement="top" title="Adicionar nova solicitação de pesquisa patrimonial.">&nbsp;&nbsp;Novo</a>
              </small> -->
        </section>
