...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                [Acompanhamento] -  
                <small>[Acompanhamento das notificações.]</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
         ...
         <div id="tracking">
            <div class="text-center tracking-status-intransit">
               <p class="tracking-status text-tight">Histórico notificações</p>
            </div>
             ...
             <!--Inicio Loop -->
              ...
              @foreach($datas as $data)
               <div class="tracking-item">
                  ...
                  <div class="tracking-date">{{ date('d/m/Y', strtotime($data->data)) }}<span>{{ date('H:m:s', strtotime($data->data)) }}</span></div>
                  <div class="tracking-content">{{$data->Nome}}
                  <span>{{$data->obs}}</span></div>
               </div>
            @endforeach
            <!--Fim Loop -->   
