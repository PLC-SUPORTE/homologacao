    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                ...
                <small>[Listagem de solicitações pagas correspondente]</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ route('Painel.Correspondente.principal') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Listagem de solicitações pagas correspondente</li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                  <div class="float-right">
                      <small>
                          <a href="{{ route('Painel.Correspondente.gerarExcelPagas')}}" class="delete" target="_blank"><span class="btn btn-success fa fa-file-excel-o"> Exportar Dados</span></a>
                      </small>
                  </div>
                    <div class="box ">
