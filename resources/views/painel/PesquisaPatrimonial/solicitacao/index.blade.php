   ...
   <!-- END: SideNav-->
    ...
    <div id="main">
        ...
        <div class="row">
          ...
          <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.solicitacoes')}}">
          ...
          <div class="col s6 m4 l2 x4">
          <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.solicitacoesemandamento')}}">
         ...
         <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.solicitacoesfinalizadas')}}">
         ...
         <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.solicitacoes')}}">
          ...
          <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.create')}}">
                ...
                <div class="card-content">
                  ...
                  <div class="col s12 m2 l3">
                     <ul class="doughnut-chart-legend">
                        <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.solicitacoes')}}"><li class="status1 ultra-small"><span class="legend-color"></span>Aguardando montagem ficha financeira</li>
