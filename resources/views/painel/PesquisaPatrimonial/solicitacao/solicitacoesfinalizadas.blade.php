...
@section('title') Solicitações de pesquisa patrimonial finalizadas @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black">Solicitações de pesquisa patrimonial finalizadas
</li>
@endsection
@section('body')
   <div>
