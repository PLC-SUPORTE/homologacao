...
<div class="row">
      ...
      <div class="card-panel">
          <div class="row mt-5">
              <div class="col s12" style="margin-top: -20px;">
               ...
               <p class="m-0" style="font-size: 10px;">Nome/Razão: {{$datas->Descricao}}</p> 
               ...
               @else
               <p class="m-0" style="font-size: 10px;">Nome/Razão: Aguardando cadastro da outra parte</p> 
   ...
   <div id="modalStatus" class="modal">
      ...
      <h5>Status</h5>
       <div class="row">
            ...
            <th style="font-size: 10px;">Ação</th>
            </tr>
            </thead>
            <tbody>
            ...
            <a href="{{route('Painel.PesquisaPatrimonial.verpesquisa', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                                                         
            </tr>
            @endforeach
   ...
   <div id="modalImovel" class="modal" style="width: 1200px;">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">Dat.Matrícula</th>
            <th style="font-size: 10px;">UF</th>
            <th style="font-size: 10px;">Tipo Imóvel</th>
            <th style="font-size: 10px;">Valor Penal</th>
            <th style="font-size: 10px;">Aver.Penhora?</th>
            <th style="font-size: 10px;">Dat.Requer.Imóvel</th>
            <th style="font-size: 10px;">Status</th>
            <th style="font-size: 10px;">Há restrição?</th>
            <th style="font-size: 10px;">Ação</th>
            </tr>
            </thead>
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisaimovel', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                                                             
            </tr>
            @endforeach
   ...
   <div id="modalVeiculos" class="modal" style="width: 1200px;">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">Desc.Veículo</th>
            <th style="font-size: 10px;">Ano Modelo</th>
            <th style="font-size: 10px;">Ano Fabricação</th>
            <th style="font-size: 10px;">Há Impedimento?</th>
            <th style="font-size: 10px;">Valor Tabela Fipe</th>
            <th style="font-size: 10px;">Averbação do Art.828</th>
            <th style="font-size: 10px;">Ação</th>
            </tr>
            </thead>
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisaveiculo', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                                                                  
            </tr>
            @endforeach                                                                                
   ...
   <div id="modalEmpresa" class="modal" style="width: 1200px;">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">Razão</th>
            <th style="font-size: 10px;">Capital Social</th>
            <th style="font-size: 10px;">Dat.Fundação</th>
            <th style="font-size: 10px;">Recuperação Judicial</th>
            <th style="font-size: 10px;">Recuperação ExtraJudicial</th>
            <th style="font-size: 10px;">Falência</th>
            <th style="font-size: 10px;">Ação</th>
            </tr>
            </thead>
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisaempresa', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                            
            </tr>
            @endforeach   
   ...
   <div id="modalInfoJud" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisainfojud', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                           
            </tr>
            @endforeach
   ...
   <div id="modalBacenJud" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisabacenjud', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                          
            </tr>
            @endforeach
   ...
   <div id="modalProtestos" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisaprotestos', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                          
            </tr>
            @endforeach
   ...
   <div id="modalRedesSociais" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisaredessociais', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                                                                   
            </tr>
            @endforeach
   ...
   <div id="modalProcessosJudiciais" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisaprocessosjudiciais', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                      
            </tr>
            @endforeach
  ...
  <!--Pesquisa Cadastral -->
   <div id="modalPesquisaCadastral" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisapesquisacadastral', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                     
            </tr>
            @endforeach
  ...
  <!--Dossie Comercial -->
   <div id="modalDossie" class="modal">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisadossiecomercial', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                             
            </tr>
            @endforeach
   ...
   <div id="modalDados" class="modal" style="width: 1200px;">
      ...
      <div class="row">
            ...
            <th style="font-size: 10px;">Grupo econômico</th>
            <th style="font-size: 10px;">Grupo cliente</th>
            <th style="font-size: 10px;">Nº Processo</th>
            <th style="font-size: 10px;">Nº da Pasta</th>
            ...
            <th style="font-size: 10px;">
            <a href="{{route('Painel.PesquisaPatrimonial.solicitacao.verpesquisadados', $codigo)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar está pesquisa"><i class="material-icons">list</i></a>
            </td>                                            
            </tr>
            @endforeach
