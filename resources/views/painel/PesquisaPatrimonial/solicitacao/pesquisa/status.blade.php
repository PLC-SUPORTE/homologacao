        ...
        <nav class="white hide-on-med-and-down" id="horizontal-nav">
          <div class="nav-wrapper">
            <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
              <li><a href="#" style="font-size: 11px;"><i class="material-icons">content_paste</i><span><span class="dropdown-title" data-i18n="Dashboard">Status</span></a></li>
  ...
  <div class="users-list-filter">
    <div class="card-panel">
      <div class="row">
          ...
          <div class="col s12 m6 l4 tooltipped" data-position="top" data-tooltip="Resultado da pesquisa." >
            <label for="users-list-verified">Resultado da Pesquisa:</label>
            <div class="input-field">
            <input name="resultadopesquisa" id="resultadopesquisa" type="text" value="{{$resultadopesquisa}}" readonly>
            </div>
          </div>

          <div class="col s12 m6 l4 tooltipped" data-position="top" data-tooltip="Status da pesquisa." >
