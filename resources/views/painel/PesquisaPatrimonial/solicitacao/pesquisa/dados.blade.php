...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba dados | Pesquisa patrimonial</title>
...
<div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
        ...
        <ol class="breadcrumbs mb-0">
          ...
          <li class="breadcrumb-item active" style="color: black;">Aba dados
          </li>
        </ol>
    </div>
          ...
          <table id="users-list-datatable" class="table">
            ...
            <?php foreach($datas as $data):?>
              <tr>
                ...
                <td style="font-size: 10px;"><?=$data->NumeroProcesso?></td>
                <td style="font-size: 10px;"><?=$data->NumeroPasta?></td>
                <td style="font-size: 10px;"><?=$data->TipoProjeto?></td>
                <td style="font-size: 10px;">R$ <?php echo number_format($data->ValorCausa, 2); ?></td>
              </tr>
             <?php endforeach;?>
