...
@section('title') Solicitações aguardando revisão do supervisor de pesquisa patrimonial @endsection <!-- Titulo da pagina -->

@section('header') 
    <title>Solicitações aguardando revisão do supervisor de pesquisa patrimonial | Portal PL&C</title>
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando revisão do supervisor de pesquisa patrimonial
</li>
@endsection
@section('body')
   <div>
