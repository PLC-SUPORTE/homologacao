...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Dashboard financeiro | Portal PL&C</title>
   ...
   <!-- END: SideNav-->
    ...
    <div id="main">
        ...
        <div class="row">
          ...
          <div class="col s6 m4 l2 x4">
          <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesemandamento')}}">
         ...
         <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesfinalizadas')}}">
         ...
         <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesaguardandocliente')}}">
         ...
         <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesaguardandocliente')}}">
          ...
          <div class="col s6 m4 l2 x4">
          <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoes')}}">
              <div class="card tooltipped"  data-position="top" data-tooltip="Valor a pagar dos boletos anexados pelo núcleo de pesquisa patrimonial." >
                    <div class="card-content cyan white-text">
                    <p class="card-stats-title" style="font-size: 12px">Valor a pagar boletos</p>
                ...
                <div class="card-content">
                  ...
                  <div class="col s12 m2 l3">
                     <ul class="doughnut-chart-legend">
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesaguardandoficha')}}"><li class="status1 ultra-small"><span class="legend-color"></span>Aguardando montagem da ficha financeira</li></a>
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesaguardandocliente')}}"><li class="status2 ultra-small"><span class="legend-color"></span> Aguardando pagamento do cliente</li>
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesaguardandorevisaosupervisor')}}"><li class="status3 ultra-small"><span class="legend-color"></span> Aguardando avaliação do supervisor</li>
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoes')}}"><li class="status4 ultra-small"><span class="legend-color"></span>Aguardando avaliação do financeiro</li>
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoes')}}"><li class="status5 ultra-small"><span class="legend-color"></span> Solicitações não cobrável para cliente</li>
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoes')}}"><li class="status6 ultra-small"><span class="legend-color"></span> Aguardando pagamento dos boletos pelo financeiro</li> </a>
                      <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoesemandamento')}}"><li class="status7 ultra-small"><span class="legend-color"></span> Pesquisas em andamento</li> </a>
                     </ul>
                  </div>
          ...
          <th style="font-size: 11px">Ação</th>
                ...
                @foreach($datas as $data)  
                  <tr>
                    ...
                    <td style="font-size: 10px">{{ $data->TipoServico}}</td>
                    ...
                    <a style="color: gray;"  href="{{route('Painel.PesquisaPatrimonial.solicitacao.capa', $data->OutraParte)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para visualizar a capaa deste pesquisado."><i class="material-icons">remove_red_eye</i></a>
                    @endif
