...
@section('title') Solicitações aguardando montagem da ficha financeira @endsection <!-- Titulo da pagina -->

@section('header') 
    <title>Solicitações aguardando montagem da ficha financeira | Portal PL&C</title>
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando montagem da ficha financeira
</li>
@endsection
@section('body')
   <div>
