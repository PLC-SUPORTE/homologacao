...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Configuração peso | Portal PL&C</title>
          ...
          <div class="nav-wrapper">
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                ...
                <li class="breadcrumb-item active" style="color: black;">Peso
                </li>
              </ol>
          </div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      <thead>
        <tr>
          ...
          <th style="font-size: 11px">Gera debite</th>
...
<!--Modal perguntando -->
<div id="modaleditar{{$data->id}}" class="modal" style="width: 1207px;">
    <form id="form2" role="form" action="{{ route('Painel.PesquisaPatrimonial.ti.peso.editado') }}" method="POST" role="create" enctype="multipart/form-data" >
    {{ csrf_field() }}
  ...
  <button type="button" class="btn waves-effect mr-sm-1 mr-2 modal-close red" style="margin-top: -26px; margin-left: 1080px;position: fixed;"><i class="material-icons">close</i></button>
      ...
      <h5>Editar peso</h5>
      <p>Favor alterar abaixo o campo peso.

      <br>

        <div class="input-field col s4">
          <input readonly id="tiposolicitacao" type="text" name="tiposolicitacao" value="{{ $data->descricao }}" class="validate">
          <label for="tiposolicitacao">Tipo solicitação:</label>
        </div>

        <div class="input-field col s3">
          <input required id="peso" type="text" placeholder="Informe o peso..." name="peso" value="{{$data->peso}}" class="validate">
    ...
    <div class="modal-footer" style="margin-top: 90px;">
      <button type="submit" id="btnsubmit" class="modal-action waves-effect waves-green btn-flat" style="background-color: gray;color:white;"><i class="material-icons left">save_alt</i>Salvar</button>
    </div>
...
<!--Fim Modal -->
          ...
          <td style="font-size: 10px">{{ $data->peso}}</td>
          @if($data->status == "A")
          <td style="font-size: 10px"><span class="bullet green"></span>Ativo</td>
          @else 
          <td style="font-size: 10px"><span class="bullet red"></span>Ínativo</td>
          @endif
          <td style="font-size: 10px">
      
          <div class="invoice-action">
          <a href="#modaleditar{{$data->id}}" class="invoice-action-view mr-4 modal-trigger tooltipped" data-position="bottom" data-tooltip="Clique aqui para alterar o peso deste tipo de solicitação."><i class="material-icons">edit</i></a>
          </div>
          </td>
