...
<li class="breadcrumb-item"><a href="{{ route('Painel.PesquisaPatrimonial.supervisao.solicitacoes') }}">Solicitações
                ...
                <div class="container">
                    ...
                    <section class="invoice-edit-wrapper section">
                        ...
                        <form role="form" id="form"
                            action="{{ route('Painel.PesquisaPatrimonial.supervisao.avaliada') }}" method="POST"
                                ...
                                <div class="col xl9 m8 s12">
                                    <div class="card">
                                        ...
                                        <a href="{{route('Painel.PesquisaPatrimonial.anexo', $datas->anexo)}}"
                                            ...
                                            style="margin-left: 895px;margin-top:-10px;background-color: gray;"><i
