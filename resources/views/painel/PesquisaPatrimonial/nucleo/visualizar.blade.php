      ...
      @endif
        ...
        <div class="card-content px-36">
          ...
          <div class="row">
            ...
            <span style="font-size: 11px;">Comarca</span>
            <select class="invoice-item-select browser-default" name="comarcas[]" style="font-size:10px;">
            ...
            <div class="col m3 s12 input-field">
              ...
              <select class="invoice-item-select browser-default"  name="assertiva[]" style="font-size:10px;">
            ...
            <div class="col m12 s12 input-field">
              <span id="labelvalor" name="labelvalor" style="font-size: 11px;">Anexar boleto:</span>
              <input style="font-size: 10px;"  type="file" id="select_file"  name="anexoboleto[]" multiple accept=".jpg,.png,.xls,.xlsx,.pdf,.doc,.docx,.rtf,.jpeg" required class="dropify" data-default-file="" />
            </div>
...
function adicionanovasolicitacao() {
  ...
  html += '<select class="invoice-item-select browser-default"  name="assertiva[]" style="font-size:10px;">';
  ...
  html += '<span style="font-size: 11px;">Anexar arquivo:</span>';
  html += '<input type="file" name="anexoboleto[]"  accept=".jpg,.png,.xls,.xlsx,.pdf,.doc,.docx,.rtf,.jpeg"  style="font-size:10px;"required >'
  html += '</div>';
