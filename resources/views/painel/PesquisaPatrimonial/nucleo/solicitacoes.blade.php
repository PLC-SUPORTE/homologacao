...
@section('title') Solicitações de pesquisa patrimonial  @endsection <!-- Titulo da pagina -->

@section('header') 
    <title>Solicitações de pesquisa patrimonial | Portal PL&C</title>
...
<li class="breadcrumb-item active" style="color: black;">Solicitações de pesquisa patrimonial
</li>
@endsection
@section('body')
   <div>
    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      @foreach($datas as $data)  
        <tr>
          ...
          @if($data->StatusID == 4 && $data->TipoServico == "Pesquisa prévia")
