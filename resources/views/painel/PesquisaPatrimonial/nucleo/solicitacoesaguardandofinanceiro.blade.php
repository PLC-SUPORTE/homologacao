...
@section('title') Solicitações aguardando pagamento dos boletos pelo financeiro @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando pagamento dos boletos pelo financeiro
</li>
@endsection
@section('body')
   <div>
