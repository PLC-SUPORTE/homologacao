...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Dashboard | Portal PL&C</title>
   ...
   <!-- END: SideNav-->
    ...
    <div id="main">
        ...
        <div class="row">
          ...
          <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoes')}}">
          <div class="card tooltipped"  data-position="top" data-tooltip="Total solicitações de pesquisa patrimonial efetuadas pelo seu usuário." >
               ...
               <p class="card-stats-title" style="font-size: 12px">Total de solicitações</p>
          ...
          <div class="col s6 m4 l2 x4">
          <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesemandamento')}}">
         ...
         <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesfinalizadas')}}">
         ...
         <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandocliente')}}">
         ...
         <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandocliente')}}">
          ...
          <div class="col s6 m4 l2 x4">
          <a href="{{route('Painel.PesquisaPatrimonial.financeiro.solicitacoes')}}">
              <div class="card tooltipped"  data-position="top" data-tooltip="Valor a pagar pela equipe do financeiro dos boletos anexados pelo núcleo de pesquisa patrimonial." >
                    <div class="card-content cyan white-text">
                    <p class="card-stats-title" style="font-size: 12px">Valor a pagar financeiro</p>
                    <h4 class="card-stats-number white-text" style="font-size: 16px;">R$ <?php echo number_format($ValorPagar, 2,",",".") ?></h4>
                       <p class="card-stats-compare">
                       </p>
                    </div>
                 </div>
            ...
            <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.Nucleo.create')}}">
          <div class="card tooltipped"  data-position="top" data-tooltip="Clique aqui para criar uma nova solicitação de pesquisa patrimonial." >
                <div class="card-content white-text" style="background-color: green;">
                <p class="card-stats-title" style="font-size: 12px"><i class="material-icons">add</i>&nbsp;&nbsp;Nova solicitação</p>
                   <p class="card-stats-compare">
                   </p>
                </div>
             </div>
          ...
          <div class="col s6 m4 l2 x4">
         <a href="{{route('Painel.PesquisaPatrimonial.nucleo.boleto.index')}}">
          <div class="card tooltipped"  data-position="top" data-tooltip="Clique aqui para acompanhar a cobrança ao cliente." >
                <div class="card-content white-text" style="background-color: gray;">
                <p class="card-stats-title" style="font-size: 12px"><i class="material-icons">list</i>&nbsp;&nbsp;Acompanhar cobrança</p>
                   <p class="card-stats-compare">
                   </p>
                </div>
             </div>
                ...
                <div class="card-content">
                  ...
                  <div class="col s12 m2 l3">
                     <ul class="doughnut-chart-legend">
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandoficha')}}"><li class="status1 ultra-small"><span class="legend-color"></span>Aguardando montagem da ficha financeira</li></a>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.boleto.index')}}"><li class="status2 ultra-small"><span class="legend-color"></span> Aguardando envio do boleto para o cliente</li>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandocliente')}}"><li class="status2 ultra-small"><span class="legend-color"></span> Aguardando pagamento do cliente</li>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandorevisaosupervisor')}}"><li class="status3 ultra-small"><span class="legend-color"></span> Aguardando avaliação do supervisor</li>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandorevisaofinanceiro')}}"><li class="status4 ultra-small"><span class="legend-color"></span>Aguardando avaliação do financeiro</li>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesreprovadas')}}"><li class="status4 ultra-small"><span class="legend-color"></span>Aguardando edição pelo núcleo</li>
                        <!-- <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesnaocobravel')}}"><li class="status5 ultra-small"><span class="legend-color"></span> Solicitações não cobrável para cliente</li> -->
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandoanexonucleo')}}"><li class="status6 ultra-small"><span class="legend-color"></span>Aguardando o anexo dos boletos pelo núcleo</li> </a>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesaguardandofinanceiro')}}"><li class="status6 ultra-small"><span class="legend-color"></span> Aguardando pagamento dos boletos pelo financeiro</li> </a>
                        <a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesemandamento')}}"><li class="status7 ultra-small"><span class="legend-color"></span> Pesquisas em andamento</li> </a>
                     </ul>
                  </div>
          ...
          <th style="font-size: 11px">Ação</th>
                ...
                @foreach($datas as $data)  
                  ...
                  <td style="font-size: 10px;">{{ $data->CPF }}</td>
                    ...
                    <td style="font-size: 10px">Aguardando pesquisa prévia</td>
                    @else 
                    ...
                    <a href="{{route('Painel.PesquisaPatrimonial.nucleo.alterarforma', $data->Id)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para alterar o fluxo de pagamento desta solicitação de pesquisa patrimonial."><i class="material-icons">lock_open</i></a>
                    ...
                    @elseif($data->StatusID == 4 && $data->TipoServico == "Pesquisa prévia")
                    <a href="{{route('Painel.PesquisaPatrimonial.nucleo.pesquisaprevia.abas', $data->Id)}}" class="invoice-action-view mr-4 tooltipped" data-position="bottom" data-tooltip="Clique aqui para preencher as informações desta solicitação de pesquisa patrimonial."><i class="material-icons">list</i></a>
                    @endif
...
!function(o, e) {
    ...
    s= {
        ...
        data: {
            ...
            labels:["Montagem da ficha financeira",
            ...
            datasets:[ {
                label: "Sales", 
                data:[{{$QuantidadeSolicitacoesAguardandoFichaFinanceira}}, {{$QuantidadeSolicitacoesAguardandoEnvioBoleto}}, {{$QuantidadeSolicitacoesAguardandoPagamentoCliente}}, {{$QuantidadeSolicitacoesAguardandoRevisao}}, {{$QuantidadeSolicitacoesAguardandoRevisaoFinanceiro}},{{$QuantidadeSolicitacoesReprovadas}} ,{{$QuantidadeSolicitacoesNaoCobravel}},{{$QuantidadeSolicitacoesAguardandoPagamentoFinanceiro}} ,{{$QuantidadeSolicitacoesEmAndamento}}], 
