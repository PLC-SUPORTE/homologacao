...
<section class="users-list-wrapper section">
  ...
  <div class="card">
  <a href="{{ route('Painel.PesquisaPatrimonial.nucleo.pesquisaprevia.cadastrar.empresa', $id) }}" class="btn-floating btn-mini waves-effect waves-light tooltipped"data-position="left" data-tooltip="Clique aqui para visualizar o seu score consolidado."  style="margin-left: 1250px;margin-top:-15px;background-color: gray;"><i class="material-icons">add</i></a>
