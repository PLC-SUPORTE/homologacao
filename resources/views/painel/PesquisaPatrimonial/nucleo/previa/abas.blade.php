...
<div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
        ...
        <ol class="breadcrumbs mb-0">
          ...
          <li class="breadcrumb-item"><a href="{{route('Painel.PesquisaPatrimonial.nucleo.solicitacoesemandamento')}}">Solicitações em andamento</a>
          </li>
    ...
    <h6 style="font-size: 20px;margin-left:-120px;">Aguarde, estamos finalizando está pesquisa prévia...</h6>
  </div>
...
<section class="users-list-wrapper section">
  <div class="users-list-filter">
    <div class="card-panel">
      ...
      <form role="form" id="form" action="{{ route('Painel.PesquisaPatrimonial.nucleo.pesquisaprevia.finalizarpesquisa') }}" method="POST" role="search"  enctype="multipart/form-data">
      {{ csrf_field() }}

       <input type="hidden" name="id" id="id" value="{{$id}}">

          <div class="col s12 m3 l3 display-flex align-items-center show-btn" style="margin-left: 900px;">
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para finalizar está pesquisa prévia."  style="background-color: gray"  href="#" onclick="abreconfirmacao();">Finalizar pesquisa prévia</a>
          </div>
...
<!-- modal -->         
 ...
 <!--Inicio Modal Anexos --> 
  <div id="modalanexos{{$id}}" class="modal modal-fixed-footer" style="width: 1200px;height:100%;overflow:hidden;">
...
left:0;
width:100%;
height:100%;" src="{{ route('Painel.PesquisaPatrimonial.veranexo', $id) }}"></iframe>
