...
<section class="users-list-wrapper section">
  <div class="users-list-filter">
    <div class="card-panel">
      ...
      <form role="form" id="form" action="{{ route('Painel.PesquisaPatrimonial.nucleo.finalizarimovel') }}" method="POST" role="search"  enctype="multipart/form-data">
      {{ csrf_field() }}
       ...
       <input type="hidden" name="numero" numero="numero" value="{{$numero}}">
           ...
           <label style="font-size: 11px;"  for="pesquisa">Imóvel pesquisa:</label>
          ...
          <label style="font-size: 11px;"  for="resultado">Resultado da Pesquisa</label>
            <div class="input-field">
            @if($statuspesquisa != "Conclúida")
          ...
          @if($statuspesquisa != "Conclúida")
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para cadastrar uma nova informação para esta pesquisa." style="background-color: gray"  href="{{ route('Painel.PesquisaPatrimonial.imovel', ['codigo' => $codigo, 'numero' => $numero])}}"><i class="material-icons">add</i></a>
          &nbsp;
...
<!-- modal -->         
                ...
                <td style="font-size: 10px;"><a href="<?=route('Painel.PesquisaPatrimonial.nucleo.editarimovel', ['codigo' => $codigo, 'numero' => $numero, 'id' => $data->Id])?>"><i class="material-icons">edit</i></a></td>
...
<div id="alertastatusconcluida" name="alertastatusconcluida" class="cd-popup" role="alert" style="margin-top:130px;">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Ao selecionar a opção [Concluída], a pesquisa de [Imóvel] será finalizada e enviado um e-mail e notificação ao solicitante.</p>
