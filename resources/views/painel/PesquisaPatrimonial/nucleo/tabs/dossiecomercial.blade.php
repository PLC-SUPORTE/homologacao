...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba dossiê comercial | Pesquisa patrimonial</title>
...
<div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
        ...
        <ol class="breadcrumbs mb-0">
          ...
          <li class="breadcrumb-item active" style="color: black;">Aba dossiê comercial
          </li>
        </ol>
    </div>
...
<section class="users-list-wrapper section">
  <div class="users-list-filter">
    <div class="card-panel">
      <div class="row">
      <form role="form" id="form" action="{{ route('Painel.PesquisaPatrimonial.nucleo.finalizardossiecomercial') }}" method="POST" role="search"  enctype="multipart/form-data">
      {{ csrf_field() }}
       ...
       <input type="hidden" name="numero" numero="numero" value="{{$numero}}">
        ...
        <label style="font-size: 11px;"  for="users-list-verified">Data solicitação:</label>
          ...
          @if($statuspesquisa != "Conclúida")
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para cadastrar uma nova informação para esta pesquisa." style="background-color: gray"  href="{{ route('Painel.PesquisaPatrimonial.comercial', ['codigo' => $codigo, 'numero' => $numero])}}"><i class="material-icons">add</i></a>
          &nbsp;
          ...
          @endif
          &nbsp;
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para gerar relatório em Excel desta pesquisa." style="background-color: gray" href="{{route('Painel.PesquisaPatrimonial.gerarexcelcomercial', $codigo)}}"><img style="margin-top: 8px; width: 20px;margin-left:8px;" src="{{URL::asset('/public/imgs/icon.png')}}"/></a>
          &nbsp;
          </div>
...
<div id="alertastatusconcluida" name="alertastatusconcluida" class="cd-popup" role="alert" style="margin-top:130px;">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Ao selecionar a opção [Concluída], a pesquisa de [Dossiê Comercial] será finalizada e enviado um e-mail e notificação ao solicitante.</p>
