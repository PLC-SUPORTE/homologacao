...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba protestos | Portal PL&C</title>
    ...
    <header class="page-topbar" id="header">
      <div class="navbar navbar-fixed"> 
        ...
        <ol class="breadcrumbs mb-0">
          ...
          <li class="breadcrumb-item active" style="color: black;">Aba protestos
          </li>
        </ol>
    </div>
...
<section class="users-list-wrapper section">
  <div class="users-list-filter">
    <div class="card-panel">
      <div class="row">
      <form role="form" id="form" action="{{ route('Painel.PesquisaPatrimonial.nucleo.finalizarprotesto') }}" method="POST" role="search"  enctype="multipart/form-data">
      {{ csrf_field() }}
       ...
       <label style="font-size: 11px;"  for="users-list-verified">Data solicitação:</label>
          ...
          @if($statuspesquisa != "Conclúida")
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para cadastrar uma nova informação para esta pesquisa." style="background-color: gray"  href="{{ route('Painel.PesquisaPatrimonial.notas', ['codigo' => $codigo, 'numero' => $numero])}}"><i class="material-icons">add</i></a>
          &nbsp;
...
<div id="alertastatusconcluida" name="alertastatusconcluida" class="cd-popup" role="alert" style="margin-top:130px;">
	<div class="cd-popup-container">
		<p style="font-weight: bold;">Ao selecionar a opção [Concluída], a pesquisa de [Protestos] será finalizada e enviado um e-mail e notificação ao solicitante.</p>
