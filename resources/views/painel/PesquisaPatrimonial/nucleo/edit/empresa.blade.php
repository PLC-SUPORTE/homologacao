...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba editar empresa | Portal PL&C</title>
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                  ...
                  <li class="breadcrumb-item active" style="color: black;">Editar Empresa
                  </li>
                </ol>
              </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'files' => true, 'route' => "Painel.PesquisaPatrimonial.updateempresa"]) ?>
         <?php @csrf ?>
         ...
         <div class="row">
              <div class="col s12 m12">
                <div class="row">
                  <div class="col s12">
                    <h6 class="mb-2">Dados pesquisa</h6>
                  </div>

                  <div class="col s2 input-field">
                    <label style="font-size: 11px;">CNPJ</label>
                    <input style="font-size: 10px;" class="validate" name="cnpj" id="cnpj" value="{{$datas->cnpj}}" type="text" onblur="pesquisacnpj();" required>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" class="validate" name="participacaosocietaria" id="participacaosocietaria" type="text">
                    <label style="font-size: 11px;">Participação sócietaria</label>
                  </div>

                  <div class="col s2 input-field">
                  <select style="font-size: 10px;" required="required" id="penhoracotas" name="penhoracotas">
                  ...
                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" class="validate" name="quantidadecotas" id="quantidadecotas" type="number" maxlength="8" pattern="(?:\.|,|[0-9])*">
                    <label style="font-size: 11px;">Quantidade de cotas</label>
                  </div>

                  <div class="col s2 input-field">
                    <label style="font-size: 11px;" for="datapenhoracotas">Data penhora cotas</label>
                    <input style="font-size: 10px;" class="validate" name="datapenhoracotas" id="datapenhoracotas" type="date" max="{{$datahoje}}">
                  </div>

                  <div class="col s2 input-field">
                  <select style="font-size: 10px;" required="required" id="penhoradofaturamento" name="penhoradofaturamento">
                  <option value="SIM">SIM</option>
                  <option value="NÃO">NÃO</option>
                  </select>
                  <label style="font-size: 11px;">Penhora do faturamento</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" class="validate" name="datapenhorafaturamento" id="datapenhorafaturamento"  type="date" max="{{$datahoje}}">
                    <label style="font-size: 11px;" for="datapenhorafaturamento">Data penhora faturamento</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" placeholder="Situação.." class="validate" name="situacao" value="{{$datas->situacao}}" id="situacao" required type="text">
                    <label style="font-size: 11px;">Situação</label>
                  </div>

                  
                  <div class="col s2 input-field">
                  <select style="font-size: 10px;" required="required" id="recuperacaojudicial" name="recuperacaojudicial">
                  <option value="SIM">SIM</option>
                  <option value="NÃO">NÃO</option>
                  </select>
                  <label style="font-size: 11px;">Recuperação judicial?</label>
                  </div>

                  <div class="col s2 input-field">
                  <select style="font-size: 10px;" required="required" id="falencia" name="falencia">
                  <option value="SIM">SIM</option>
                  <option value="NÃO">NÃO</option>
                  </select>
                  <label style="font-size: 11px;">Faléncia?</label>
                  </div>

                  <div class="col s2 input-field">
                  <select style="font-size: 10px;" required="required" id="recuperacao" name="recuperacao">
                  <option value="SIM">SIM</option>
                  <option value="NÃO">NÃO</option>
                  </select>
                  <label style="font-size: 11px;">Recuperação extrajudicial?</label>
                  </div>
               ...
               <div class="col s12 m12">
                <div class="row">
                  ...
                  <div class="col s4 input-field">
                    <input style="font-size: 10px;" name="razaosocial" id="razaosocial" value="{{$datas->razao}}"  type="text" required class="validate">
                    <label style="font-size: 11px;" for="razaosocial">Razão social</label>
                  </div>

                  <div class="col s4 input-field">
                    <input style="font-size: 10px;" name="nomefantasia" id="nomefantasia" value="{{$datas->nomefantasia}}" type="text" required class="validate">
                    <label style="font-size: 11px;" for="nomefantasia">Nome fantasia</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="objetosocial" id="objetosocial" value="{{$datas->objetosocial}}" type="text" required class="validate">
                    <label style="font-size: 11px;" for="objetosocial">Objeto social</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="logradouro" id="logradouro" value="{{$datas->logradouro}}" type="text" required class="validate">
                    <label style="font-size: 11px;" for="logradouro">Logradouro</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="numero" id="numero" value="{{$datas->numero}}"  type="text" class="validate">
                    <label style="font-size: 11px;" for="numero">Complemento</label> 
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="bairro" id="bairro" value="{{$datas->bairro}}" required type="text" class="validate">
                    <label style="font-size: 11px;" for="bairro">Bairro</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="municipio" id="municipio" value="{{$datas->municipio}}" required type="text" class="validate">
                    <label style="font-size: 11px;" for="municipio">Municipio</label>
                  </div>

                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="cep" id="cep" value="{{$datas->cep}}" required type="text" class="validate">
                    <label style="font-size: 11px;" for="cep">CEP</label>
                  </div>

                  
                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" name="uf" id="uf" value="{{$datas->uf}}" required type="text" class="validate">
                    <label style="font-size: 11px;" for="uf">UF</label>
                  </div>

                  <div class="col s2 input-field">
                      <input style="font-size: 10px;" name="capitalsocial" id="capitalsocial" type="text" value="<?php echo number_format($datas->capitalsocial, 2,',', '.'); ?>" required onKeyPress="return(moeda2(this,'.',',',event))" class="validate">
                      <label style="font-size: 11px;" for="uf">Capital social</label>
                    </div>
                  ...
                  <div class="col s2 input-field">
                    ...
                    <label style="font-size: 11px;" for="datafundacao">Data fundação</label>
                  </div>

                  <div class="col s6 input-field">
                  <select required="required" style="width: 100%;heigth: 100%;font-size:10px;" multiple id="socios" name="socios[]">
                  <option></option>
                  </select>
                  <label style="font-size: 11px;">Sócios</label>
                </div>
