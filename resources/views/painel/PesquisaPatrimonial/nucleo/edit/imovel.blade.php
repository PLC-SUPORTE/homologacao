...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba editar imóvel | Portal PL&C</title>
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                  ...
                  <li class="breadcrumb-item active" style="color: black;">Editar Imóvel
                  </li>
                </ol>
          </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'files' => true, 'route' => "Painel.PesquisaPatrimonial.updateimovel"]) ?>
         <?php @csrf ?>
              ...
              <div class="col s12 m12">
                <div class="row">
                  ...
                  <div class="col s2 input-field">
                    <span style="font-size: 11px">Número da matricula:</label>
                    <input style="font-size: 10px;" class="validate" name="numeromatricula" value="{{$datas->matricula}}" id="numeromatricula" type="text" required>
                  </div>

                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Selecione o tipo de imóvel:</span>
                  <select class="browser-default" style="font-size: 10px;" required="required" id="tipoimovel" name="tipoimovel">
                  <option selected="selected" value="{{$datas->tipoimovelid}}">{{$datas->tipoimoveldescricao}}</option>
                 ...
                 <div class="col s2 input-field">
                 <span style="font-size: 11px">Data da matricula:</label>
                  <input style="font-size: 10px;" name="datamatricula" id="datamatricula" required type="date" value="{{ date('Y-m-d', strtotime($datas->datamatricula)) }}" max="{{$datahoje}}" class="validate">
                  </div>

                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Valor total:</label>
                  ...
                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Valor de alienação:</label>
                  ...
                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Valor disponível:</label>
                  <input style="font-size: 10px;"type="text" name="valor_disponivel" id="valor_disponivel" value="<?php echo number_format($datas->valor_disponivel, 2,",",".") ?>" class="valor">
                  </div>

                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Data de requerimento:</label>
                    <input style="font-size: 10px;" class="validate" name="datarequerimento" id="datarequiremento" required type="date" value="{{ date('Y-m-d', strtotime($datas->datarequerimento)) }}" max="{{$datahoje}}">
                  </div>
                  ...
                  <span style="font-size: 11px">Averbação Art. 828:</span>
                    ...
                    <option value="{{$datas->averbacao828}}" selected>{{$datas->averbacao828}}</option>
                  ...
                  <span style="font-size: 11px">Houve Averb. da Penhora:</span>
                    <select class="browser-default" style="font-size: 10px;" required="required" id="averbacaopenhora" name="averbacaopenhora">
                    <option value="{{$datas->penhora}}" selected>{{$datas->penhora}}</option>
                    <option value="SIM">SIM</option>
                    <option value="NÃO">NÃO</option>
                    </select>
                  </div>
                  ...
                  <div class="input-field col s2">
                    <label style="font-size: 10px;" for="nome" style="margin-top: -27px; font-size: 11px;">Carta enviada?</label><br>
                    <p>
                      <label>
                ...
                <span style="font-size: 11px">Data do envio da carta:</span>
                  <input style="font-size: 10px;" class="validate" name="datacarta" id="datacarta" type="date" value="{{ date('Y-m-d', strtotime($datas->datacarta)) }}" max="{{$datahoje}}">
              </div>
                ...
                <option value="{{$datas->statusid}}" selected>{{$datas->statusdescricao}}</option>
                ...
                <span style="font-size: 11px">Há Impedimento:</span>
                  ...
                  <option value="{{$datas->impedimento}}" selected>{{$datas->impedimento}}</option>
                  <option value="SIM">SIM</option>
                  <option value="NÃO">NÃO</option>
                  </select>
                  </div>
                  ...
                  <span style="font-size: 11px">CEP:</span>
                    <input style="font-size: 10px;" name="cep" id="cep" type="text" value="{{$datas->cep}}" size="10" maxlength="9" onblur="pesquisacep();"placeholder="Digite o cep">
                  </div>

                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Logradouro:</span>
                    <input style="font-size: 10px;" name="rua" id="rua" value="{{$datas->rua}}" type="text" >
                  </div>

                 <div class="col s2 input-field">
                  <span style="font-size: 11px">Bairro:</span>
                  <input style="font-size: 10px;" name="bairro" id="bairro" value="{{$datas->bairro}}" type="text">
                  </div>

                  <div class="col s2 input-field">
                  <span style="font-size: 11px">Cidade:</span>
                    <input style="font-size: 10px;" name="cidade" id="cidade" value="{{$datas->cidade}}" type="text">
                  </div>

                  <div class="col s1 input-field">
                  <span style="font-size: 11px">UF:</span>
                    <input style="font-size: 10px;" name="uf" id="uf" value="{{$datas->uf}}" type="text">
                  </div>
                  ...
                  <div class="row">
                  <div class="col s2 input-field">
                    <input style="font-size: 10px;" id="select_file" name="select_file[]" type='file' required>
                </div>
...
$('#valor').blur(function(){
        ...
        document.getElementById('valor_disponivel').value=(valor);
