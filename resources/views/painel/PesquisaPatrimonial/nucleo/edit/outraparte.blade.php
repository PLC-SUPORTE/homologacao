...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba editar status | Portal PL&C</title>
    ...
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/themes/horizontal-menu-template/materialize.min.css">
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/themes/horizontal-menu-template/style.min.css">
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/layouts/style-horizontal.min.css">
    <link rel="stylesheet" type="text/css" href="https://pixinvent.com/materialize-material-design-admin-template/app-assets/css/pages/dashboard.min.css">
        ...
        <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
          ...
          <ol class="breadcrumbs mb-0">
            <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
              ...
              <li class="breadcrumb-item active" style="color: black;">Editar Status
              </li>
            </ol>
      </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'files' => true, 'route' => "Painel.PesquisaPatrimonial.updateoutraparte"]) ?>
         <?php @csrf ?>
            ...
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <select style="font-size: 10px;" required id="cshopping" name="cshopping" class="select2 browser-default" >
                  <option  value="<?=$datas->clienteid?>"><?=$datas->clientedescricao?></option>
                    <?php foreach($clientes as $data):?>  
                    <option  value="<?=$data->Codigo?>"><?=$data->Descricao?></option>
                    <?php endforeach;?>
                    </select>
                    <label style="font-size: 11px;">Selecione o cliente</label>
                  </div>

                  <div class="col s4 input-field">
                  <select style="font-size: 10px;" required="required" id="classificacao" name="classificacao" class="select2 browser-default">
                  <option value="{{$datas->classificacao}}">{{$datas->classificacao}}</option>
                  <option value="SIM">SIM</option>
                  <option value="Não Autorizada">Não Autorizada </option>
                  <option value="Não solicitada">Não solicitada </option>
                  </select>
                  <label style="font-size: 11px;">Selecione a classificação</label>

                  </div>
                  <div class="col s12 input-field">
                    <input style="font-size: 10px;" id="select_file" name="select_file[]" multiple type='file'>
                  </div>
                </div>
              </div>
              ...
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s4 input-field">
                  <input name="data" id="data" required type="text" value="{{date('d/m/Y', strtotime($datas->data))}}" max="{{$datahoje}}" class="validate">
                  <label for="name">Data solicitação</label>
                  </div>

                  <div class="col s6 input-field">
                  <select class="select2 browser-default"  required="required" id="status" name="status"  data-toggle="tooltip" data-placement="left" title="Selecione o status.">
                  <option value="{{$datas->statusid}}">{{$datas->statusdescricao}}</option>
    ...
    <script src="{{ asset('/public/materialize/js/search.min.js') }}"></script>
