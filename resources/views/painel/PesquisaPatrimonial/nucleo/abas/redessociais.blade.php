...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba cadastro redes social | Portal PL&C</title>
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                  ...
                  <li class="breadcrumb-item active" style="color: black;">Cadastro Redes Sociais
                  </li>
                </ol>
              </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'onsubmit' => "btnsubmit.disabled = true; return true;", 'files' => true, 'route' => "Painel.PesquisaPatrimonial.storeredessocias"]) ?>
         <?php @csrf ?>
                ...
                <table class="mt-1">
                  <thead>
                    <tr>
                      ...
                      <th style="font-size:11px;">Não pesquisado</th>
                      <th style="font-size:11px;">Link</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php foreach($redesocials as $data):?>  
                    <tr>
                      <td><?=$data->Nome?></td>
                      <input type="hidden" name="redesocial[]" value="<?=$data->Id?>" id="redesocial"/><span></span>
                      <td><label><input style="font-size:10px;"type="checkbox" value="Pesquisado" checked name="encontrado[]" id="encontrado"/><span></span></label></td>
                      <td><label><input style="font-size:10px;"type="checkbox" value="Não pesquisado" name="encontrado[]" id="encontrado"/><span></span></label></td>
                      <td><label><input style="font-size:10px;" type="text" name="observacao[]" id="observacao"  placeholder="https://" /><span></span></label></td>
                    </tr>
                  <?php endforeach;?>
                  </tbody>
                </table>
