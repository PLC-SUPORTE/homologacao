...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba cadastro diversos | Portal PL&C</title>
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                  ...
                  <li class="breadcrumb-item active" style="color: black;">Cadastro diversos
                  </li>
                </ol>
              </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'files' => true, 'onsubmit' => "btnsubmit.disabled = true; return true;", 'route' => "Painel.PesquisaPatrimonial.storediversos"]) ?>
         <?php @csrf ?>
         ...
         <div class="row">
              <div class="col s12 m6">
                ...
                <label for="valor_alienacao" style="color: black;font-size:11px;">Valor da alienação:</label>
                </div>
