...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba cadastro processo judicial | Portal PL&C</title>
            ...
            <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down"><span style="color: white;">Pesquisa patrimonial</span></h5>
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                  ...
                  <li class="breadcrumb-item active" style="color: black;">Cadastro Processo Judicial
                  </li>
                </ol>
              </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'onsubmit' => "btnsubmit.disabled = true; return true;", 'files' => true, 'route' => "Painel.PesquisaPatrimonial.storetribunal"]) ?>
         <?php @csrf ?>
         ...
         <div class="row">
              <div class="col s12 m6">
                ...
                <input style="font-size:11px;" type="text" name="valor" id="valor" value="00,00" class="valor" onKeyPress="javascript:return(moeda2(this,event))"> 
