...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba cadastro joias | Portal PL&C</title>
            ...
            <div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
              ...
              <ol class="breadcrumbs mb-0">
                <li class="breadcrumb-item"><a href="{{route('Home.Principal.Show')}}">Home</a>
                  ...
                  <li class="breadcrumb-item active" style="color: black;">Cadastro de joias
                  </li>
                </ol>
              </div>
  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'files' => true, 'onsubmit' => "btnsubmit.disabled = true; return true;", 'route' => "Painel.PesquisaPatrimonial.storejoias"]) ?>
         <?php @csrf ?>
              ...
              <div class="col s12 m6">
                ...
                <div class="input-field col s12">
                       <div class="form-group">
                        <div class="form-group">
                        <label style="font-size: 11px;" class="control-label">Observação:</label>
                ...
                <div class="col s3 input-field">
                    ...
                    <select class="browser-default" style="font-size: 10px;" class="browser-default" required="required" id="tipo" name="tipo">
                    <option selected="selected" value="Joias">Joias</option>
