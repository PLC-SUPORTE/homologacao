  ...
  <div class="card">
    <div class="card-content">
      ...
      <div class="row">
        ...
        <?= Form::open(['method'=>'POST', 'onsubmit' => "btnsubmit.disabled = true; return true;", 'files' => true, 'route' => "Painel.PesquisaPatrimonial.storeimovel"]) ?>
         <?php @csrf ?>
              ...
              <div class="col s12 m12">
                ...
                <div class="col s2 input-field">
                  ...
                  <div class="col s2 input-field">
                    ...
                    <select style="font-size: 10px;" required="required" id="tipoimovel" name="tipoimovel">
                 ...
                 <div class="col s2 input-field">
                    ...
                    <input style="font-size: 10px;" name="datamatricula" id="datamatricula" required type="date" max="{{$datahoje}}" class="validate">
                  </div>
                  ...
                  <div class="col s2 input-field">
                    ...
                    <input  style="font-size: 10px;" class="validate" name="datarequerimento" id="datarequiremento" required type="date" max="{{$datahoje}}">
                  </div>
                    ...
                    <div class="col s2 input-field">
                      ...
                      <input style="font-size: 10px;" placeholder="Informe a cidade." name="cidade" id="cidade" value="" type="text" >
                    </div>
  
                    <div class="col s1 input-field">
                      <span style="font-size: 11px">UF</span>
                      <input style="font-size: 10px;" placeholder="UF..." name="uf" id="uf" value="" type="text">
                    </div>
