...
@section('title') Solicitações aguardando pagamento do boleto pelo cliente @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando pagamento do boleto pelo cliente
</li>
@endsection
@section('body')
   <div>
