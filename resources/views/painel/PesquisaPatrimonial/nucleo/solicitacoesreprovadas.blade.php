...
@section('title') Solicitações aguardando edição @endsection <!-- Titulo da pagina -->

@section('header') 
    <title>Solicitações aguardando edição | Portal PL&C</title>
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando edição
</li>
@endsection
@section('body')
   <div>
