...
@section('title') Solicitações aguardando revisão do financeiro @endsection <!-- Titulo da pagina -->
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando revisão do financeiro
</li>
@endsection
@section('body')
   <div>
