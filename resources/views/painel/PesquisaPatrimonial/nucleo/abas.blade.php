...
<html class="loading" lang="pt-br" data-textdirection="ltr">
  <head>
    ...
    <title>Aba status | Portal PL&C</title>
...
<div class="breadcrumbs-inline pt-3 pb-1" id="breadcrumbs-wrapper" style="margin-top: -40px;">
        ...
        <ol class="breadcrumbs mb-0">
          ...
          <li class="breadcrumb-item active" style="color: black;">Aba status
          </li>
        </ol>
    </div>
        ...
        <nav class="white hide-on-med-and-down" id="horizontal-nav">
          <div class="nav-wrapper">
            <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation" style="overflow: hidden">
              <li><a href="#" style="font-size: 10px;"><i class="material-icons">content_paste</i><span><span class="dropdown-title" data-i18n="Dashboard">Status</span></a></li>
...
<section class="users-list-wrapper section">
  <div class="users-list-filter">
    <div class="card-panel">
      ...
      <form role="form" id="form" action="{{ route('Painel.PesquisaPatrimonial.nucleo.finalizarstatus') }}" method="POST" role="search"  enctype="multipart/form-data">
      {{ csrf_field() }}

       <input type="hidden" name="codigo" id="codigo" value="{{$codigo}}">
       <input type="hidden" name="numero" numero="numero" value="{{$numero}}">

          <div class="col s12 m3 l4 tooltipped" data-position="top" data-tooltip="Resultado da pesquisa." >
            <label style="font-size: 11px;" for="users-list-verified">Resultado da Pesquisa:</label>
            @if($statuspesquisa != "Conclúida")
            <div class="input-field">
              <select  required id="resultadopesquisa" name="resultadopesquisa">
          ...
          <div class="col s12 m3 l4 tooltipped" data-position="top" data-tooltip="Status da pesquisa." >
          ...
          @if($statuspesquisa != "Conclúida")
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para cadastrar uma nova informação para esta pesquisa." style="background-color: gray"  href="{{ route('Painel.PesquisaPatrimonial.outraparte', ['codigo' => $codigo, 'numero' => $numero])}}"><i class="material-icons">add</i></a>
          &nbsp;
          ...
          @endif
          &nbsp;
          <a class="btn btn-block waves-effect waves-light tooltipped" data-position="top" data-tooltip="Clique aqui para gerar relatório em Excel desta pesquisa." style="background-color: gray" href="{{route('Painel.PesquisaPatrimonial.gerarexceloutraparte', $codigo)}}"><img style="margin-top: 8px; width: 20px;margin-left:8px;" src="{{URL::asset('/public/imgs/icon.png')}}"/></a>
          &nbsp;
          </div>
          ...
          <table id="users-list-datatable" class="table">
            ...
            <?php foreach($datas as $data):?>
              <tr>
                ...
                <td style="font-size: 11px;"><?=$data->Status?></td>
                <td style="font-size: 11px;"><a href="<?=route('Painel.PesquisaPatrimonial.nucleo.editaroutraparte', ['codigo' => $codigo, 'numero' => $numero, 'id' => $data->Id])?>"><i class="material-icons">edit</i></a></td>
                <td style="font-size: 11px;"><a href="#modalanexos{{$codigo}}" class="tooltipped modal-trigger" data-position="bottom" data-tooltip="Clique aqui para visualizar os anexos deste pesquisado..."><i class="material-icons">attach_file</i></a></td>
              </tr>
             <?php endforeach;?>
