      ...
      <h6 style="font-size: 20px;margin-left:-210px;">Aguarde, estamos criando a solicitação de pesquisa patrimonial...</h6>
        ...
        <div class="card-content">
            <p class="caption mb-0" style="font-size: 11px;">
                Favor preencher os campos abaixo para o cadastro de uma nova solicitação de pesquisa patrimonial.
            </p>
        </div>
    </div>


                     <form role="form" id="form" onsubmit="btnsubmit.disabled = true; return true;" action="{{ route('Painel.PesquisaPatrimonial.Nucleo.store') }}" method="POST" role="search"  enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="input-field col s3" id="clienteextrajudicial">
      ...
      success: function(response) {
        ...
        var selectbox = $('#clienteselected');
          $.each(response, function (i, d) {
              selectbox.append('<option value="' + d.id_referencia + '">' + d.descricao + '</option>');
        });
