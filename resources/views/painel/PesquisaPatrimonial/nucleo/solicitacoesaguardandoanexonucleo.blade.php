...
@section('title') Solicitações aguardando o anexo dos boletos pela equipe do núcleo @endsection <!-- Titulo da pagina -->

@section('header') 
    <title>Solicitações aguardando o anexo dos boletos pela equipe do núcleo| Portal PL&C</title>
...
<li class="breadcrumb-item active" style="color: black;">Solicitações aguardando o anexo dos boletos pela equipe do núcleo
</li>
@endsection
@section('body')
   <div>
